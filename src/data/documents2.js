export default [
  {
    document: {
      ...
      paragraphs: [
        ...
        {
          text: '— Como, senhor? Mas o crime do réu está mais que provado.',
          footnote: []
        },
        {
          text: '— Deixemos de debate, disse eu, e todos concordaram comigo.',
          footnote: []
        },
        {
        ...
        {
          text: '— Como se chama? perguntou o presidente.',
          footnote: []
        },
        {
          text: '— Antônio do Carmo Ribeiro Lopes.',
          footnote: []
        },
        {
  ...
  },
  {
    document: {
      ...
      paragraphs: [
        ...
        {
          text: 'Equécrates – Então, procura contar-nos com a maior exatidão possível como tudo se passou, no caso de dispores de folga.',
          footnote: [],
          bold: [
            {
              firstIndex: 0,
        ...
        {
          text: 'Equécrates – Pois podes ter a certeza, Fedão, de que teus ouvintes estão nessas mesmas condições. Esforça-te, portanto, para contar o caso com todas as minúcias.',
          footnote: [],
          bold: [
            {
              firstIndex: 0,
        ...
        {
          text: 'Logo, é por medo e temor que os homens são corajosos, com exceção dos filósofos, muito embora se nos afigure paradoxal ser alguém corajoso por temor e pusilanimidade.',
          footnote: [],
          bold: []
        },
        {
        ...
        {
          text: 'Que é, então, o que provém do vivo?',
          footnote: [],
          bold: [{
            firstIndex: '',
            lastIndex: ''
        ...
        {
          text: 'O morto, respondeu.',
          footnote: [],
          bold: []
        },
        {
          text: 'E do morto, voltou a falar, o que se origina?',
          footnote: [],
          bold: []
        },
        {
          text: 'Será forçoso convir que é o vivo.',
          footnote: [],
          bold: []
        },
        {
          text: 'Sendo assim, Cebete, do que está morto provêm os homens e tudo o que tem vida?',
          footnote: [],
          bold: []
        },
        {
          text: 'É evidente, respondeu.',
          footnote: [],
          bold: []
        },
        {
          text: 'Logo, continuou, nossas almas estão no Hades.',
          footnote: [],
          bold: []
        },
        {
        ...
        {
          text: 'Sem dúvida nenhuma, respondeu.',
          footnote: [],
          bold: []
        },
        {
        ...
        {
          text: 'É o seguinte: uma coisa é conhecimento do homem, e outra o da lira.',
          footnote: [],
          bold: []
        },
        {
        ...
        {
          text: 'Milhares, por Zeus, respondeu Símias.',
          footnote: [],
          bold: []
        },
        {
        ...
        {
          text: 'E diante do retrato de Símias, lembrar-se do próprio Símias?',
          footnote: [],
          bold: []
        },
        {
          text: 'Isso também, foi a resposta.',
          footnote: [],
          bold: []
        },
        {
        ...
        {
          text: 'Existe, por Zeus, exclamou Símias; à maravilha.',
          footnote: [],
          bold: []
        },
        {
          text: 'E que também saberemos o que seja?',
          footnote: [],
          bold: []
        },
        {
        ...
        {
          text: 'Está muito certo o que afirmaste, disse.',
          footnote: [],
          bold: []
        },
        {
          text: 'Que pode ser semelhante àqueles ou dessemelhantes?',
          footnote: [],
          bold: []
        },
        {
        ...
        {
          text: 'É a consequência necessária, Sócrates, do que foi dito antes.',
          footnote: [],
          bold: []
        },
        {
        ...
        {
          text: 'Não será outra coisa, Sócrates, respondeu.',
          footnote: [],
          bold: []
        },
        {
        ...
        {
          text: 'Tudo se passa realmente desse modo, Sócrates.',
          footnote: [],
          bold: []
        },
        {
        ...
        {
          text: 'Assim de pronto, Sócrates, não sei como decidir-me.',
          footnote: [],
          bold: []
        },
        {
        ...
        {
          text: 'Necessariamente, Sócrates, respondeu.',
          footnote: [],
          bold: []
        },
        {
        ...
        {
          text: 'De forma alguma.',
          footnote: [],
          bold: []
        },
        {
          text: 'Nesse caso, recordam-se do que aprenderam antes?',
          footnote: [],
          bold: []
        },
        {
          text: 'Necessariamente.',
          footnote: [],
          bold: []
        },
        {
        ...
        {
          text: 'Não há jeito, Sócrates, sem o querer, disse uma tolice.',
          footnote: [],
          bold: []
        },
        {
        ...
        {
          text: 'E a Cebete? Perguntou; precisas também convencer Cebete.',
          footnote: [],
          bold: []
        },
        {
        ...
        {
          text: 'Agrada-me a proposta, como não?',
          footnote: [],
          bold: []
        },
        {
        ...
        {
          text: 'Acho que é assim mesmo, observou Cebete.',
          footnote: [],
          bold: []
        },
        {
        ...
        {
          text: 'O que dizes, observou, é a pura verdade.',
          footnote: [],
          bold: []
        },
        {
        ...
        {
          text: 'Admitamos também esse ponto, respondeu.',
          footnote: [],
          bold: []
        },
        {
          text: 'Então, prossigamos, uma parte de nós mesmos não é corpo, e a outra não é alma?',
          footnote: [],
          bold: []
        },
        {
          text: 'Sem dúvida, falou.',
          footnote: [],
          bold: []
        },
        {
        ...
        {
          text: 'Para todo o mundo é evidente que é com a das coisas visíveis.',
          footnote: [],
          bold: []
        },
        {
          text: 'E com relação à alma? É visível, ou será invisível?',
          footnote: [],
          bold: []
        },
        {
          text: 'Pelo menos para o homem, não o será, Sócrates, respondeu.',
          footnote: [],
          bold: []
        },
        {
        ...
        {
          text: 'Não; é com a natureza humana, mesmo.',
          footnote: [],
          bold: []
        },
        {
          text: 'E a alma? Que diremos dela: poderemos vê-la ou não?',
          footnote: [],
          bold: []
        },
        {
        ...
        {
          text: 'De toda a necessidade, Sócrates.',
          footnote: [],
          bold: []
        },
        {
        ...
        {
          text: 'Tudo isso, Sócrates, é verdadeiro e foi muito bem enunciado.',
          footnote: [],
          bold: []
        },
        {
        ...
        {
          text: 'E com qual deles a alma se parece?',
          footnote: [],
          bold: []
        },
        {
          text: 'Evidentemente, Sócrates, a alma se assemelha ao divino, e o corpo ao mortal .',
          footnote: [],
          bold: []
        },
        {
        ...
        {
          text: 'De forma alguma, respondeu.',
          footnote: [],
          bold: []
        },
        {
        ...
        {
          text: 'É muito possível, Sócrates, que seja assim mesmo.',
          footnote: [],
          bold: []
        },
        {
        ...
        {
          text: 'A que a naturezas te referes, Sócrates?',
          footnote: [],
          bold: []
        },
        {
        ...
        {
          text: 'Falas com muita propriedade.',
          footnote: [],
          bold: []
        },
        {
        ...
        {
          text: 'Não há dúvida, respondeu Cebete; é para esses corpos que elas vão.',
          footnote: [],
          bold: []
        },
        {
        ...
        {
          text: 'É claro, observou; nem poderia ser de outra maneira.',
          footnote: [],
          bold: []
        },
        {
        ...
        {
          text: 'Por que serão esses os mais felizes?',
          footnote: [],
          bold: []
        },
        {
        ...
        {
          text: 'De fato, Sócrates; nada disso lhes ficaria bem, falou Cebete.',
          footnote: [],
          bold: []
        },
        {
        ...
        {
          text: 'Qual é, Sócrates? perguntou Cebete.',
          footnote: [],
          bold: []
        },
        {
        ...
        {
          text: 'É muito certo o que disseste, observou Cebete.',
          footnote: [],
          bold: []
        },
        {
        ...
        {
          text: 'Penso que sim, Sócrates, respondi.',
          footnote: [],
          bold: []
        },
        {
          text: 'Não, se me aceitares um conselho.',
          footnote: [],
          bold: []
        },
        {
          text: 'Que devo, então, fazer? Perguntei.',
          footnote: [],
          bold: []
        },
        {
        ...
        {
          text: 'Mas, como se costuma dizer, objetei-lhe, contra dois nem Hércules aguenta.',
          footnote: [],
          bold: []
        },
        {
          text: 'Então, chama-me em teu auxílio, enquanto é dia; serei o teu Iolau.',
          footnote: [],
          bold: []
        },
        {
        ...
        {
          text: 'É muito provável, respondi.',
          footnote: [],
          bold: []
        },
        {
        ...
        {
          text: 'É muito certo o que dizes, observei.',
          footnote: [],
          bold: []
        },
        {
        ...
        {
          text: 'Por Zeus, lhe disse; seria, de fato grande lástima.',
          footnote: [],
          bold: []
        },
        {
        ...
        {
          text: 'Ambos confirmaram a pergunta.',
          footnote: [],
          bold: []
        },
        {
        ...
        {
          text: 'Alguns, sim, responderam, outros não.',
          footnote: [],
          bold: []
        },
        {
        ...
        {
          text: 'De forma alguma, Sócrates, respondeu.',
          footnote: [],
          bold: []
        },
        {
        ...
        {
          text: 'Não há jeito, respondeu Símias.',
          footnote: [],
          bold: []
        },
        {
        ...
        {
          text: 'Sem dúvida, observou Símias.',
          footnote: [],
          bold: []
        },
        {
        ...
        {
          text: 'É que não compete à harmonia conduzir os elementos que a compõem, porém seguilos.',
          footnote: [],
          bold: []
        },
        {
          text: 'Declarou-se também de acordo.',
          footnote: [],
          bold: []
        },
        {
        ...
        {
          text: 'Nunca dos nuncas, respondeu.',
          footnote: [],
          bold: []
        },
        {
        ...
        {
          text: 'Donde vem que não participará em grau maior nem da harmonia nem da desarmonia.',
          footnote: [],
          bold: []
        },
        {
        ...
        {
          text: 'Como não poderá a alma, por ser totalmente alma, participar do vício.',
          footnote: [],
          bold: []
        },
        {
          text: 'Como o poderia, de acordo com o que dissemos antes?',
          footnote: [],
          bold: []
        },
        {
        ...
        {
          text: 'É também o que eu penso, Sócrates, respondeu.',
          footnote: [],
          bold: []
        },
        {
        ...
        {
          text: 'Admitimos isso, por que não?',
          footnote: [],
          bold: []
        },
        {
        ...
        {
          text: 'Bate, indignado, no peito e a si próprio desta arte se exprime:',
          footnote: [],
          bold: []
        },
        {
          text: 'Sê, coração, paciente, pois vida mais baixa e mesquinha já suportaste.',
          footnote: [],
          bold: []
        },
        {
        ...
        {
          text: 'Por Zeus, Sócrates, é também o que eu penso.',
          footnote: [],
          bold: []
        },
        {
        ...
        {
          text: 'Não desejo outra coisa, falou Cebete.',
          footnote: [],
          bold: []
        },
        {
        ...
        {
          text: 'E agora, perguntou Cebete, como te parece?',
          footnote: [],
          bold: []
        },
        {
        ...
        {
          text: 'Não há o que eu mais deseje, respondeu.',
          footnote: [],
          bold: []
        },
        {
        ...
        {
          text: 'Sem dúvida, respondeu rindo Cebete.',
          footnote: [],
          bold: []
        },
        {
        ...
        {
          text: 'Falaste a pura verdade, disseram a um só tempo, Símias e Cebete.',
          footnote: [],
          bold: []
        },
        {
        ...
        {
          text: 'L – E depois disso, o que disseram?',
          footnote: [],
          bold: [{
            firstIndex: 0,
            lastIndex: 2
        ...
        {
          text: 'É exatamente assim que eu penso, observou Cebete.',
          footnote: [],
          bold: []
        },
        {
        ...
        {
          text: 'Sem a mínima restrição, foi a sua resposta.',
          footnote: [],
          bold: []
        },
        {
        ...
        {
          text: 'E serão, porventura, o mesmo que a neve e o fogo?',
          footnote: [],
          bold: []
        },
        {
          text: 'Não, por Zeus; nunca afirmei semelhante coisa.',
          footnote: [],
          bold: []
        },
        {
          text: 'Logo, o quente não é a mesma coisa que o fogo, nem o frio o mesmo que a neve.',
          footnote: [],
          bold: []
        },
        {
        ...
        {
          text: 'Falaste com muito acerto, observou.',
          footnote: [],
          bold: []
        },
        {
        ...
        {
          text: 'Como não admitir? Foi a sua resposta.',
          footnote: [],
          bold: []
        },
        {
        ...
        {
          text: 'É muito certo, falou Cebete.',
          footnote: [],
          bold: []
        },
        {
          text: 'No entanto, continuou, os números dois e três não são contrários entre si.',
          footnote: [],
          bold: []
        },
        {
        ...
        {
          text: 'É muito certo o que afirmas, respondeu.',
          footnote: [],
          bold: []
        },
        {
        ...
        {
          text: 'Que queres dizer com isso?',
          footnote: [],
          bold: []
        },
        {
        ...
        {
          text: 'O que a constitui é a idéia do ímpar, não é isso mesmo?',
          footnote: [],
          bold: []
        },
        {
        ...
        {
          text: 'Como o seu contrário é a idéia do par.',
          footnote: [],
          bold: []
        },
        {
        ...
        {
          text: 'Sendo assim, no três jamais entrará a idéia de par.',
          footnote: [],
          bold: []
        },
        {
        ...
        {
          text: 'Pelo simples fato de o três não participar do par.',
          footnote: [],
          bold: []
        },
        {
        ...
        {
          text: 'Não somente estou de inteiro acordo, disse, como te acompanho.',
          footnote: [],
          bold: []
        },
        {
        ...
        {
          text: 'À maravilha, respondeu.',
          footnote: [],
          bold: []
        },
        {
          text: 'Então, me digas, continuou, que precisa haver no corpo para que ele viva?',
          footnote: [],
          bold: []
        },
        {
        ...
        {
          text: 'E sempre terá de ser assim?',
          footnote: [],
          bold: []
        },
        {
          text: 'Por que não? Foi sua resposta.',
          footnote: [],
          bold: []
        },
        {
          text: 'Logo, tudo o de que a alma se apodera, a isso ela dá vida?',
          footnote: [],
          bold: []
        },
        {
          text: 'É o que ela faz, de fato, respondeu.',
          footnote: [],
          bold: []
        },
        {
          text: 'E porventura haverá alguma coisa contrária à vida? Ou não há?',
          footnote: [],
          bold: []
        },
        {
        ...
        {
          text: 'Conclusão certíssima, respondeu Cebete.',
          footnote: [],
          bold: []
        },
        {
        ...
        {
          text: 'Ímpar, respondeu.',
          footnote: [],
          bold: []
        },
        {
          text: 'E o que não recebe o justo, ou não recebe o harmônico?',
          footnote: [],
          bold: []
        },
        {
          text: 'Desarmônico, disse, ou injusto.',
          footnote: [],
          bold: []
        },
        {
          text: 'Muito bem. E o que não recebe a morte, como denominaremos?',
          footnote: [],
          bold: []
        },
        {
          text: 'Imortal, foi a sua resposta.',
          footnote: [],
          bold: []
        },
        {
          text: 'Ora, a alma não recebe a morte.',
          footnote: [],
          bold: []
        },
        {
        ...
        {
          text: 'Ficou demonstrado à saciedade, Sócrates.',
          footnote: [],
          bold: []
        },
        {
        ...
        {
          text: 'Necessariamente, respondeu.',
          footnote: [],
          bold: []
        },
        {
        ...
        {
          text: 'É muito certo o que dizes, respondeu.',
          footnote: [],
          bold: []
        },
        {
        ...
        {
          text: 'Será o suficiente, falou Símias.',
          footnote: [],
          bold: []
        },
        {
        ...
        {
          text: 'E com razão, observou Símias.',
          footnote: [],
          bold: []
        },
        {
        ...
        {
          text: 'Como quiserdes, disse; basta que segureis de verdade e que eu não vos escape.',
          footnote: [],
          bold: []
        },
        {
        ...
        {
          text: 'Só preparamos, Sócrates, respondeu, a quantidade que nos parece suficiente.',
          footnote: [],
          bold: []
        },
        {
        ...
        {
          text: 'Assim farei, respondeu Critão, vê se queres dizer mais alguma coisa.',
          footnote: [],
          bold: []
        },
        {
  ...
  },
  {
    document: {
      title: 'Relíquias de Casa Velha',
      author: 'Machado de Assis',
      section: 'Anedota do Cabriolet',
      img: 'machado',
      imgIndex: '6',
      titleURL: 'reliquias-de-casa-velha',
      authorURL: 'machado-de-assis',
      sectionURL: 'anedota-do-cabriolet',
      content: '',
      disclaimer: '',
      paragraphs: [
        {
          text: '— <i>Cabriolet</i> está aí, sim, senhor, dizia o preto que viera à matriz de S. José\n' +
        ...
        {
          text: 'A geração de hoje não viu a entrada e a saída do <i>cabriolet</i> no Rio de Janeiro.\n' +
            'Também não saberá do tempo em que o <i>cab</i> e o <i>tilbury</i> vieram para o rol dos\n' +
            ...
            'os três esqueletos. O <i>cabriolet</i> não teve história; deixou apenas a anedota que\n' +
            'vou dizer.',
          footnote: []
        },
        {
          text: '— Dois! exclamou o sacristão.',
          footnote: []
        },
        {
          text: '— Sim, senhor, dois; nhã Anunciada e nhô Pedrinho. Coitado de nhô Pedrinho! E\n' +
            'nhã Anunciada, coitada! continuou o preto a gemer, andando de um lado para\n' +
            'outro, aflito, fora de si.',
          footnote: []
        },
        {
          text: 'Alguém que leia isto com a alma turva de dúvidas, é natural que pergunte se o\n' +
        ...
        {
          text: 'Não é que o sacristão não fosse curioso. Em verdade, pouco mais era que isso.\n' +
        ...
        {
          text: '“Que Pedrinho e que Anunciada serão esses?” dizia consigo, acompanhando o\n' +
            'coadjutor.',
          footnote: []
        },
        {
          text: 'Embora ardesse por sabê-los, a presença do coadjutor impediria qualquer\n' +
            ...
            '<i>cabriolet</i> esperava-os; o cocheiro desbarretou-se, os vizinhos e alguns passantes\n' +
        ...
        {
          text: 'Que andem burros e pessoas na rua, e as nuvens no céu, se as há, e os\n' +
            'pensamentos nas cabeças, se os têm. A do sacristão tinha-os vários e confusos.\n' +
            'Não era acerca do <i>Nosso-Pai</i>, embora soubesse adorá-lo, nem da água benta e\n' +
            'do hissope que levava; também não era acerca da hora, — oito e quarto da\n' +
            'noite, — aliás, o céu estava claro e a lua ia aparecendo. O próprio <i>cabriolet</i>, que\n' +
        ...
        {
          text: '“Há de ser gente nova, ia pensando o sacristão, mas hóspede em alguma casa,\n' +
            ...
            'conhecidos, talvez, simples conhecidos. Mas então mandariam <i>cabriolet</i>? Este\n' +
            'mesmo preto é novo na casa; há de ser escravo de um dos moribundos, ou de\n' +
            'ambos.”',
          footnote: []
        },
        {
          text: 'Era assim que João das Mercês ia cogitando, e não foi por muito tempo. O\n' +
            '<i>cabriolet</i> parou à porta de um sobrado, justamente a casa do Comendador Brito,\n' +
        ...
        {
          text: 'Tudo se passou, como é de uso e regra, em tais ocasiões. Nhô Pedrinho foi\n' +
        ...
        {
          text: 'Foi tão curta a moda do <i>cabriolet</i> que este provavelmente não levou outro padre\n' +
        ...
        {
          text: 'Em caminho foi evocando toda a vida daquele homem, antes e depois da\n' +
            ...
            'saía dos queixos sem sentir. Se a regra mandasse rezar três dúzias de padrenossos\n' +
            'seguidamente, João das Mercês os diria sem contar. Tal era com as vidas\n' +
            'alheias; amava sabê-las, pesquisava-as, decorava-as, e nunca mais lhe saíam\n' +
            'da memória.',
          footnote: []
        },
        {
          text: 'Na paróquia todos lhe queriam bem, porque ele não enredava nem maldizia.\n' +
            ...
            'retificar um com outro, e os dois com Sancho, Sancho com Martinho, e viceversa,\n' +
            'todos com todos. Assim é que enchia as horas vagas, que eram muitas.\n' +
        ...
        {
          text: 'Quando chegou à casa do comendador, tinha desfiado o rosário da vida deste, e\n' +
        ...
        {
          text: '— Não morreram, nem sei se escaparão; quando menos, ela creio que morrerá,\n' +
            'concluiu Brito.',
          footnote: []
        },
        {
          text: '— Parecem bem mal.',
          footnote: []
        },
        {
          text: '— Ela, principalmente; também é a que mais padece da febre. A febre os pegou\n' +
            'aqui em nossa casa, logo que chegaram de Campinas, há dias.',
          footnote: []
        },
        {
          text: '— Já estavam aqui? perguntou o sacristão, pasmado de o não saber.',
          footnote: []
        },
        {
          text: '— Já; chegaram há quinze dias, — ou quatorze. Vieram com o meu sobrinho\n' +
            'Carlos e aqui apanharam a doença...',
          footnote: []
        },
        {
          text: 'Brito interrompeu o que ia dizendo; assim pareceu ao sacristão, que pôs no\n' +
        ...
        {
          text: '— Ah! exclamou Brito estacando o passo.',
          footnote: []
        },
        {
          text: 'Parecia haver nele o desejo impaciente de referir um caso, — a “história\n' +
        ...
        {
          text: 'João das Mercês sentou-se. Viu bem que em tal situação cumpria despedir-se\n' +
        ...
        {
          text: '— Triste, sim, triste, concordou João das Mercês. Boas pessoas, não?',
          footnote: []
        },
        {
          text: '— Iam casar.',
        ...
        {
          text: '— Casar? Noivos um do outro?',
          footnote: []
        },
        {
          text: 'Brito confirmou de cabeça. A nota era melancólica, mas não havia sinal da\n' +
        ...
        {
          text: 'Vieram trazer recado ao dono da casa; este pediu licença ao sacristão, tão\n' +
        ...
        {
          text: '— Que lhe dizia eu, há pouco? Quando menos, ela ia morrer; morreu.',
          footnote: []
        },
        {
          text: 'Brito disse isto sem lágrimas e quase sem tristeza. Conhecia a defunta de pouco\n' +
            ...
            'era natural, — o nome da defunta. O dono da casa, — ou por não querer darlho,\n' +
            '— ou porque outra idéia lhe tomasse agora a cabeça, — não declarou o\n' +
        ...
        {
          text: '— Deus a receberá em sua santa guarda, e a ele também, se vier a expirar,\n' +
            'disse o sacristão cheio de melancolia.',
          footnote: []
        },
        {
          text: 'E esta palavra bastou a arrancar metade do segredo que parece ansiava por sair\n' +
            ...
            'criados juntos, vinham casar aqui quando souberam, pela parenta de Mataporcos,\n' +
            'uma notícia abominável...',
          footnote: []
        },
        {
          text: '— E foi...? precipitou-se em dizer João das Mercês, sentindo alguma hesitação\n' +
            'no comendador.',
          footnote: []
        },
        {
          text: '— Que eram irmãos.',
          footnote: []
        },
        {
          text: '— Irmãos como? Irmãos de verdade?',
          footnote: []
        },
        {
          text: '— De verdade; irmãos por parte de mãe. O pai é que não era o mesmo. A\n' +
            'parenta não lhes disse tudo nem claro, mas jurou que era assim, e eles ficaram\n' +
            'fulminados durante um dia ou mais...',
          footnote: []
        },
        {
          text: 'João das Mercês não ficou menos espantado que eles; dispôs-se a não sair dali\n' +
        ...
        {
          text: '— E vamos, vamos, foi então que a febre os tomou...?',
          footnote: []
        },
        {
          text: 'Brito cerrou os dentes para não dizer mais nada. Como, porém, o viessem\n' +
        ...
        {
          text: '— Lá se foi o outro, o irmão, o noivo... Que Deus lhes perdoe! Saiba agora tudo,\n' +
            ...
            '<i>cabriolet</i> e fugiram de casa. Dado logo o alarma, alcançamos pegar o <i>cabriolet</i>\n' +
            'em caminho da Cidade Nova, e eles ficaram tão pungidos e vexados da captura\n' +
            'que adoeceram de febre e acabam de morrer.',
          footnote: []
        },
        {
          text: 'Não se pode escrever o que sentiu o sacristão, ouvindo-lhe este caso. Guardou-o\n' +
            ...
            'mais; meteu-se-lhe em cabeça que o <i>cabriolet</i> da fuga podia ser o mesmo dos\n' +
  ...
  },
  {
    document: {
      ...
      paragraphs: [
        ...
        {
          text: 'A verdade e a beleza devem ser postas em relação; tomadas em si\n' +
        ...
        {
          text: 'A história do pensamento de Schopenhauer faz-nos remontar à fonte do\n' +
        ...
        {
          text: 'Ter espírito científico e preparar-se para a ciência é manifestamente\n' +
        ...
        {
          text: 'Sentem todos que a esta elevação da idéia, realidade única, acima dos\n' +
            'fenômenos e da sua efêmera multiplicidade, se liga uma idéia profundamente\n' +
            'moral, a <i>desvalorização</i> do sensível em benefício do espiritual, do temporal\n' +
        ...
        {
          text: 'Mas outro valor tem esta distinção: o valor artístico. De acordo com essa\n' +
        ...
        {
          text: 'Platão artista... Uma filosofia, não o esqueçamos, não age somente - e por\n' +
        ...
        {
          text: 'O que ele ensinou não mais existe, O que ele viveu permanece de pé,\n' +
            'Contemplai-o, pois! Nada pôde submetê-lo.',
          footnote: []
        },
        {
          text: 'A doutrina de Schopenhauer, de que falaremos agora, e o dinamismo de\n' +
        ...
        {
          text: 'Emanuel Kant, crítico do conhecimento, que, do domínio da especulação,\n' +
            ...
            'eles, se chama, pois <i>imanente</i>; <i>transcendente</i> seria a que poderíamos atingir se\n' +
        ...
        {
          text: 'Tal é a concepção fundamental de Kant. Vê-se que muito se aproxima da\n' +
        ...
        {
          text: 'Tomou as "Idéias" e a "Coisa em si". Mas, com esta, ousou temerária\n' +
            ...
            '- que sabia o que ela é : a <i>Vontade</i>. Seria a causa primeira e ir redutível do ser,\n' +
            ...
            'incondicionado, um impulso cego, um <i>instinto</i> absolutamente gratuito, duma\n' +
        ...
        {
          text: 'A vontade, pois, este absoluto, exterior ao espaço, ao tempo e à\n' +
            'causalidade, cegamente e sem razão, mas com o irresistível ardor de seu\n' +
            'desejo e de sua alegria de existir, reclamaria a vida, a <i>objetivação</i>, e esta\n' +
            ...
            '<i>representação</i>, minha representação, <i>como</i> a tua, a de todo indivíduo e a\n' +
        ...
        {
          text: 'Era uma apreciação notavelmente pessimista; e, de fato, todos os\n' +
            ...
            'esforço em vista de algo, inteligência, sede ardente, cobiça, desejo, <i>sofrimento</i>,\n' +
            ...
            'todos, o auto-estraçalhamento da vontade, segundo a máxima "<i>Homo hominis\n' +
            'lupas"</i>.',
          footnote: []
        },
        {
          text: 'Tôdas as vezes que Schopenhauer evoca o sofrimento do mundo, a\n' +
        ...
        {
          text: 'Contudo, pode-se salvar o mundo da miséria., do erro, do engano e da\n' +
        ...
        {
          text: 'O que morre conosco é unicamente a individuação; a vontade, que é\n' +
        ...
        {
          text: 'Mas a inteligência não é o produto da vontade, seu instrumento, sua luz na\n' +
            ...
            'delicioso aniquilamento. Há um estado em que esse milagre se realiza: o\n' +
            ...
            'Chama-se-lhe estado <i>estético</i>. É uma das maiores e mais profundas\n' +
            ...
            'e ele o faz com uma abundância inesgotável - fala nas bênçãos da Arte.\n' +
            ...
            'apraz <i>de maneira desinteressada</i>". Para Schopenhauer isso significa\n' +
        ...
        {
          text: 'Apoio que vê longe, o Deus das Musas, ê um Deus do afastamento e da\n' +
            ...
            '"Estamos perfeitamente bera .escrevia nosso autor. - É o estado sem dor que\n' +
            ...
            'o <i>sabbat</i> dos trabalhos forçados da vontade, a roda de Ixion pára".Palavras\n' +
            'célebres, tantas vezes citadas. O belo e o alívio imenso que o contemplá-lo\n' +
            'proporciona arrancaram-nas a essa alma amarga e atormentada. Serão\n' +
            'verdadeiras?',
          footnote: []
        },
        {
          text: 'Mas que é a verdade? Uma experiência vivida que encontra tais palavras é\n' +
            ...
            'definitiva. O estado estético seria apenas uma etapa; deveria levar-nos a estado\n' +
      ...
      paragraphs: [
        ...
        },
        {
          text: 'O Dr. Lemos estava efetivamente pasmado a olhar para a figura de Luís Tinoco. Era aquele o poeta\n' +
            ...
            'poeta, do gesto arrebatado do tribuno, - uma transformação, uma criatura muito outra e muito melhor.\n' +
  ...
  },
  {
    document: {
      ...
      imgIndex: '5',
      titleURL: 'macbeth',
      authorURL: 'shakespeare',
      sectionURL: 'ato-I',
      content: '',
      disclaimer: '',
      paragraphs: [
        {
          text: '<center>Personagens</center>',
          footnote: [
            {
              index: '',
              content: ''
        ...
        {
          text: '<br>DUNCAN, rei da Escócia.<br>' +
            'MALCOLM, seu filho<br>' +
            'D0NALBAIN, seu filho.<br>' +
            'MACHBETH, General do exército do rei<br>' +
            'BANQUO, General do exército do rei.<br>' +
            'MACDUFF, Nobre da Escócia.<br>' +
            'ROSS, Nobre da Escócia.<br>' +
            'MENTEITH, Nobre da Escócia.<br>' +
            'ANGUS, Nobre da Escócia.<br>' +
            'CAITHNESS, Nobre da Escócia.<br>' +
            'FLEANCE, filho de Banquo.<br>' +
            'SIWARD, duque de Northumberland, general do exército inglês.<br>' +
            'O jovem Siward, seu filho.<br>' +
            'Seyton, oficial ligado a Macbeth.<br>' +
            'Menino, filho de Macduff.<br>' +
            'Um médico inglês.<br>' +
            'Um médico escocês.<br>' +
            'Um sargento.<br>' +
            'Um porteiro.<br>' +
            'Um velho.<br>' +
            'Lady Macbeth.<br>' +
            'Lady Macduff.<br>' +
            'Criado de quarto de Lady Macbeth.<br>' +
            'Hécate e três bruxas.<br>' +
            'Nobres, gentis-homens, oficiais, soldados, assassinos, criados e mensageiros. O fantasma de Banquo e' +
            'outras aparições.',
          footnote: []
        },
        {
          text: '<br><br><center><b>ATO I</b></center>',
          footnote: []
        },
        {
        ...
        {
          text: '<i>Lugar deserto. Trovões e relâmpagos. Entram três bruxas.</i>',
          footnote: []
        },
        {
          text: 'PRIMEIRA BRUXA - Quando estaremos à mão com chuva, raio e trovão?',
          footnote: []
        },
        {
          text: 'SEGUNDA BRUXA - Depois de calma a baralha e vencida esta batalha',
          footnote: []
        },
        {
          text: 'TERCEIRA BRUXA - Hoje mesmo, então, sem falha.',
          footnote: []
        },
        {
          text: 'PRIMEIRA BRUXA - Onde?',
          footnote: []
        },
        {
          text: 'SEGUNDA BRUXA - Da charneca ao pé.',
          footnote: []
        },
        {
          text: 'TERCEIRA BRUXA - Para encontrarmos Macbeth',
          footnote: []
        },
        {
          text: 'PRIMEIRA BRUXA - Graymalkin, não faltarei.',
          footnote: []
        },
        {
          text: 'SEGUNDA BRUXA - Paddock chama',
          footnote: []
        },
        {
          text: 'TERCEIRA BRUXA - Depressa!',
          footnote: []
        },
        {
          text: 'TODAS - São iguais o belo e o feio; andemos da névoa em meio.',
          footnote: []
        },
        {
          text: '<i>(Saem)</i>',
        ...
        {
          text: '<i>Um campo perto de Forres. Alarma dentro. Entram o rei Duncan, Malcolm, Donalbain, Lennox e\n' +
            'pessoas do séquito. Encontram um sargento ferido.</i>',
          footnote: []
        },
        {
          text: 'DUNCAN - Quem é esse indivíduo ensangüentado? Pelo que mostra, pode dizer algo sobre o estado\n' +
            'recente da revolta.',
          footnote: []
        },
        {
          text: 'MALCOLM - E o sargento que, como bom e intrépido soldado, me livrou do cativeiro. Salve, valente\n' +
            'amigo! Ao rei relata quanto sabes da luta até ao momento em que saíste dela.',
          footnote: []
        },
        {
          text: 'SARGENTO - Duvidoso era o desfecho, como dois cansados nadadores que um no outro se embaraçam,\n' +
        ...
        {
          text: 'DUNCAN - Oh bravo primo! Que digno gentil-homem!',
          footnote: []
        },
        {
          text: 'SARGENTO - Como nascem tempestades terríveis e arrebentam pavorosos trovões do mesmo lado em que o sol principia a levantar-se: da mesma fonte, assim, de onde o socorro parecia manar, surgiu o\n' +
        ...
        {
          text: 'DUNCAN - E porventura temor não causou isso em nossos cabos Banquo e Macbeth?',
          footnote: []
        },
        {
          text: 'SARGENTO - Como os pardais às águias ou a lebre ao leão. Para dizer o que houve, terei de relatar que\n' +
            'pareciam canhões com dupla carga reforçados. Assim eles redobravam no imigo duplos golpes. Se\n' +
            'queriam banhar-se em fumegantes feridas, se dar fama a um outro Gólgota, não sei dizê-lo. Mas temo\n' +
            'desmaiar; minhas feridas reclamam por socorro.',
          footnote: []
        },
        {
          text: 'DUNCAN - Teu relato te orna tão bem como esses ferimentos; lídimo sabor de honra eles revelam. Ide\n' +
            'buscar um cirurgião para ele.',
          footnote: []
        },
        {
          text: '<i>(Sai o sargento, acompanhado.)</i>',
          footnote: []
        },
        {
          text: '<i>(Entra Ross.)</i>',
        ...
        {
          text: 'MALCOLM - O muito digno thane de Ross. Nos olhos dele, quanta pressa! O olhar assim teria quem nos\n' +
            'viesse dar notícias de fatos muito estranhos.',
          footnote: []
        },
        {
          text: 'ROSS - Que Deus proteja o rei.',
          footnote: []
        },
        {
          text: 'DUNCAN - Mui digno thane, de onde vens?',
          footnote: []
        },
        {
          text: 'ROSS - Grande rei, venho de Fife, onde as bandeiras norueguesas zombam do céu e deixam fria nossa\n' +
        ...
        {
          text: 'DUNCAN - Grande felicidade!',
          footnote: []
        },
        {
          text: 'ROSS - De tal medo que Sweno, o norueguês, paz nos implora. Mas não o deixamos sepultar os mortos\n' +
            'sem que, antes, em Saint Colme, dez mil dólares houvesse pago para nossa caixa.',
          footnote: []
        },
        {
          text: 'DUNCAN - Jamais de novo há de trair o thane de Cawdor nosso afeto. Sem delongas o condenai à morte\n' +
            'e com seu título saudai Macbeth.',
          footnote: []
        },
        {
          text: 'ROSS - A mim tomo esse encargo.',
          footnote: []
        },
        {
          text: 'DUNCAN - Folga Macbeth com o que para ele é amargo',
          footnote: []
        },
        {
          text: '<i>(Saem)</i>',
        ...
        {
          text: '<i>A charneca. Trovões. Entram as três bruxas.</i>',
          footnote: []
        },
        {
          text: 'PRIMEIRA BRUXA - Onde estiveste, irmã?',
          footnote: []
        },
        {
          text: 'SEGUNDA BRUXA - Matando porco.',
          footnote: []
        },
        {
          text: 'TERCEIRA BRUXA - E tu, irmã?',
          footnote: []
        },
        {
          text: 'PRIMEIRA BRUXA - Cheio o regaço tinha de castanhas a mulher de um marujo, e mastigava, mascava,\n' +
            'mastigava. "Cede-me uma", lhe disse. "Vai-te embora, bruxa!" grita-me a gorda comedora de babugem.\n' +
            'Em caminho de Alepo está o marido, como chefe do "Tigre". Mas como rato cotó numa peneira vou só.\n' +
            'E roque, roque, roque!',
          footnote: []
        },
        {
          text: 'SEGUNDA BRUXA - Vou dar-te um bom vento.',
          footnote: []
        },
        {
          text: 'PRIMEIRA BRUXA - Vem a meu contento.',
          footnote: []
        },
        {
          text: 'TERCEIRA BRUXA - Com mais um podes contar.',
          footnote: []
        },
        {
          text: 'PRIMEIRA BRUXA - Saberei outros achar e os portos de mais zunidos e os pontos deles sabidos na\n' +
            'carta dos marinheiros. Vou deixá-lo como enguia, sem que o sono, noite e dia, lhe baixe aos olhos um\n' +
            'nada. Vai ser vida amaldiçoada. Semanas noventa e nove, fraco e magro, nem se move; e embora não\n' +
            'perca o barco, de tufões não será parco. Vê o que eu trouxe!',
          footnote: []
        },
        {
          text: 'SEGUNDA BRUXA - Mostra-me! Mostra-me!',
          footnote: []
        },
        {
          text: 'PRIMEIRA BRUXA - O dedo de um marinheiro que naufragou no roteiro.\n',
          footnote: []
        },
        {
          text: '<i>(Barulho de tambor, dentro.)</i>',
          footnote: []
        },
        {
          text: 'TERCEIRA BRUXA - Tambor! Tambor! Eis Macbeth, o vencedor!',
          footnote: []
        },
        {
          text: 'TODAS - As três bruxas, mãos unidas, por estradas não batidas, por mar e terra se vão. Três para ti, três\n' +
            'a mim. três para nove no fim. Silêncio! O encanto está pronto.',
          footnote: []
        },
        {
        ...
        {
          text: 'MACBETH - Nunca vi dia assim, tão feio e belo.',
          footnote: []
        },
        {
          text: 'BANQUO - A que distância ainda se encontra Forres? Quem são essas criaturas tão mirradas e de vestes\n' +
            'selvagens, que habitantes não parecem da terra e, no entretanto, nela se movem? Acaso tendes vida? Sois\n' +
            'algo a que perguntas dirijamos? Pareceis compreender-me, pois a um tempo levais os dedos ósseos a\n' +
            'esses lábios encarquilhados. Quase vos tomara por mulheres; no entanto vossas barbas não me permitem\n' +
            'dar-vos esse nome.',
          footnote: []
        },
        {
          text: 'MACBETH - Respondei, se puderdes: quem sois vós?',
          footnote: []
        },
        {
          text: 'PRIMEIRA BRUXA - Viva, viva Macbeth! Nós te saudamos, thane de Glamis!',
          footnote: []
        },
        {
          text: 'SEGUNDA BRUXA - Viva, viva Macbeth! Nós te saudamos, thane de Cawdor!',
          footnote: []
        },
        {
          text: 'TERCEIRA BRUXA - Viva Macbeth, que há de ser rei mais tarde!',
          footnote: []
        },
        {
          text: 'BANQUO - Meu bondoso senhor, por que motivo vos mostrais assustado, parecendo recear o que de\n' +
            'ouvir é assim tão belo? Em nome da verdade, imaginárias sereis realmente, ou o que mostrais por fora?\n' +
            'Meu nobre companheiro foi saudado com títulos, por vós, de atual valia e grande predição de haveres\n' +
            'nobres e de real esperança, que parece deixá-lo arrebatado. Porém nada me dissestes. Se podeis ver a\n' +
            'seara do tempo e predizer quais as sementes que hão de brotar, quais não, falai comigo, que não procuro\n' +
            'nem receio vosso ódio ou vosso favor.',
          footnote: []
        },
        {
          text: 'PRIMEIRA BRUXA - Salve!',
          footnote: []
        },
        {
          text: 'SEGUNDA BRUXA - Salve!',
          footnote: []
        },
        {
          text: 'TERCEIRA BRUXA - Salve!',
          footnote: []
        },
        {
          text: 'PRIMEIRA BRUXA - Menor do que Macbeth, porém maior!',
          footnote: []
        },
        {
          text: 'SEGUNDA BRUXA - Não tão feliz, mas muito mais feliz!',
          footnote: []
        },
        {
          text: 'TERCEIRA BRUXA - Gerarás reis, embora rei não sejas! Assim, viva Macbeth e viva Banquo!',
          footnote: []
        },
        {
          text: 'PRIMEIRA BRUXA - Viva Banquo e Macbeth! A todos, viva!',
          footnote: []
        },
        {
          text: 'MACBETH - Um momento, oradoras imperfeitas. Falai-me mais um pouco. Pela morte de Sinel eu\n' +
            'fiquei thane de Glamis. Mas, Cawdor, de que jeito? Vive o thane de Cawdor, gentil-homem muito\n' +
            'próspero; e ser rei ultrapassa os horizontes da crença tanto ou mais do que ser Cawdor. Dizei de onde\n' +
            'tirastes tão insólita notícia e por que causa nos fizestes parar nesta charneca desolada, com saudações\n' +
            'proféticas? Intimo-vos a me falar.',
          footnote: []
        },
        {
          text: '<i>(As bruxas desaparecem.)</i>',
          footnote: []
        },
        {
          text: 'BANQUO - A terra tem borbulhas, tal como a água. Elas são justamente isso. Mas para onde sumiram?',
          footnote: []
        },
        {
          text: 'MACBETH - No ar; e tudo quanto nos parecia ser corpóreo se fundiu como ao vento nosso anélito. Oh!\n' +
            'se tivessem demorado um pouco!',
          footnote: []
        },
        {
          text: 'BANQUO - Aqui estiveram, mesmo, essas criaturas sobre que conversamos, ou teríamos comido da raiz\n' +
            'malsã que deixa prisioneira a razão?',
          footnote: []
        },
        {
          text: 'MACBETH - Reis, vossos filhos?',
          footnote: []
        },
        {
          text: 'BANQUO - Chegareis a rei.',
          footnote: []
        },
        {
          text: 'MACBETH - E assim, thane de Cawdor. Não foi isso?',
          footnote: []
        },
        {
          text: 'BANQUO - Esse, o tom e as palavras. Quem vem vindo?',
          footnote: []
        },
        {
          text: '<i>(Entram Ross e Angus.)</i>',
          footnote: []
        },
        {
          text: 'ROSS - Macbeth, com alegria o rei as novas recebeu da vitória que obtiveste, e quando ouve falar que\n' +
            'aventuraste tua pessoa contra esses rebeldes, põem-se nele a lutar os elogios e a admiração sobre que\n' +
            'parte fora justo te reservar, qual a ele próprio. Se sobre isso não fala, compendiando quanto houve neste\n' +
            'dia extraordinário, descobre-te na fila dos intrépidos noruegueses, impávido ante as formas da morte\n' +
            'estranhas por ti próprio criadas. Bastos como granizo, os mensageiros se sucediam, todos portadores de\n' +
            'encômios para ti nesta grandiosa defesa de seu reino, derramando-lhe aos pés os elogios.',
          footnote: []
        },
        {
          text: 'ANGUS - Aqui estamos para trazer-te os agradecimentos de nosso real senhor e te levarmos à sua frente,\n' +
            'não para pagar-te.',
          footnote: []
        },
        {
          text: 'ROSS - E como arras de uma honra de mais vulto, por ele devo te chamar de thane de Cawdor. Salve,\n' +
            'pois, mui digno thane, por essa promoção, pois teu é o título.',
          footnote: []
        },
        {
          text: 'BANQUO - Como! Falou o diabo, então, verdade?',
          footnote: []
        },
        {
          text: 'MACBETH - Vive o thane de Cawdor; qual a causa de me vestirdes com a roupagem de outrem?',
          footnote: []
        },
        {
          text: 'ANGUS - O que foi thane ainda está com vida: mas sob pesado juízo a vida se acha que ele malbaratou.\n' +
            'Ou mantivesse combinação com os próprios noruegueses, ou por meios secretos os rebeldes procurasse\n' +
            'auxiliar, ou dos dois lados se empenhasse na ruína de sua pátria, não sei dizê-lo; mas o certo é que altas\n' +
            'traições, já confessadas e provadas, o fizeram cair.',
          footnote: []
        },
        {
          text: 'MACBETH <i>(à parte)</i> - Glamis e thane de Cawdor... O maior virá a seu tempo. <i>(A Ross e Angus.)</i>\n' +
            'Agradeço o trabalho. <i>(A Banquo.)</i> Esperançado não ficais de que venham vossos filhos a ser reis, uma\n' +
            'vez que as que de thane de Cawdor me chamaram, não menores coisas lhes prometeram?',
          footnote: []
        },
        {
          text: 'BANQUO - Uma grande confiança na promessa poderia vos inflamar para chegar ao trono, mais que\n' +
            'thane de Cawdor. Mas é estranho; por vezes, para nos perdermos, contam-nos os agentes das trevas\n' +
            'alguns fatos verídicos, seduzem-nos com coisas inocentes, porém de pouca monta, para nos arrastar a\n' +
            'conseqüências incalculáveis. Primo, uma palavrinha, por obséquio',
          footnote: []
        },
        {
          text: 'MACBETH <i>(à parte)</i> - Duas verdades foram ditas, prólogo feliz do ato elevado, cujo tema é\n' +
            ...
            'sentimos é menos de temer que as mais terríveis mas fictícias criações. Meu pensamento no qual o crime\n' +
            'por enquanto é apenas um fantasma, a tal ponto o pobre reino de minha alma sacode, que esmagada se\n' +
            'torna a vida pela fantasia, sem que haja nada além do que não é.',
          footnote: []
        },
        {
          text: 'BANQUO - Como ficou absorto nosso amigo!',
          footnote: []
        },
        {
          text: 'MACBETH <i>(à parte)</i> - Se o acaso quer que eu seja rei, o acaso me poderá coroar sem que eu me mexa.',
          footnote: []
        },
        {
          text: 'BANQUO - As honras mais recentes caem nele como em nós roupa nova, que somente com o uso vêm a\n' +
            'se ajeitar no corpo.',
          footnote: []
        },
        {
          text: 'MACBETH <i>(à parte)</i> - Venha o que vier, que a hora da alegria chega depois do mais cansado dia.',
          footnote: []
        },
        {
          text: 'BANQUO - Digno Macbeth, por vós é que esperamos.',
          footnote: []
        },
        {
          text: 'MACBETH - Desculpai-me; mas meu pesado cérebro se ocupava com coisas esquecidas. Vosso\n' +
            'trabalhos, dignos cavalheiros, gravados ficam onde diariamente virar eu possa as folhas para lê-los.\n' +
            'Procuremos o rei. <i>(A Banquo.)</i> Pensai no que houve, que mais tarde, depois de refletirmos, com o\n' +
            'coração aberto falaremos.',
          footnote: []
        },
        {
          text: 'BANQUO - Pois não.',
          footnote: []
        },
        {
          text: 'MACBETH - Por hoje basta. Amigos, vamos!',
          footnote: []
        },
        {
          text: '<i>(Saem.)</i>',
        ...
        {
          text: '<i>Forres. Um quarto no palácio. Fanfarra. Entram Duncan, Malcolm, Donalbain, Lennox e pessoas do\n' +
            'séqüito.</i>',
          footnote: []
        },
        {
          text: 'DUNCAN - Cawdor já foi executado? Os homens incumbidos do feito já voltaram?',
          footnote: []
        },
        {
          text: 'MALCOLM - Meu suserano, ainda não vieram; mas falei com alguém que o viu morrer, que me disse\n' +
            'haver ele confessado francamente as traições, pedido a Vossa Grandeza lhe perdoasse e revelado grande\n' +
            'arrependimento. Nada em vida tanto o ornou como o modo de deixá-la. Morreu tal como se estudado\n' +
            'houvesse como na hora da morte desfazer-se do mais precioso bem, como se fosse de somenos valor.',
          footnote: []
        },
        {
          text: 'DUNCAN - Não existe arte que ensine a ler no rosto as feições da alma. Era um fidalgo em quem\n' +
            'depositava absoluta confiança.',
          footnote: []
        },
        {
          text: '<i>(Entram Macbeth, Banquo, Ross e Angus.)</i>',
          footnote: []
        },
        {
          text: 'Ó digno primo! Neste instante pesava-me o pecado de minha ingratidão. Tão na dianteira te achas agora,\n' +
        ...
        {
          text: 'MACBETH - O serviço e a lealdade que vos devo por si mesmos se pagam, competindo tão-somente a\n' +
        ...
        {
          text: 'DUNCAN - Sê bem-vindo. A plantar-te comecei; hei de esforçar-me, assim, para que alcances\n' +
        ...
        {
          text: 'BANQUO - Se em tal terreno eu me der bem, vossa será a colheita.',
          footnote: []
        },
        {
          text: 'DUNCAN - As minhas abundantes alegrias, ébrias de plenitude, ora procuram ocultar-se nas togas da\n' +
            ...
            'Mas não há de essa honra a ele somente ornar. Não; como estrelas, títulos brilharão de alta nobreza sobre\n' +
            'quem merecer. <i>(A Macbeth.)</i> Daqui sigamos para Inverness, a fim de que se dobrem minhas obrigações\n' +
            'para convosco.',
          footnote: []
        },
        {
          text: 'MACBETH - Trabalho será o ócio que em proveito vosso não for usado. Eu mesmo quero ser o\n' +
            'aposentador de Vossa Alteza, para que jubilosos os ouvidos deixe de minha esposa com a notícia de que\n' +
            'em breve estareis em nossa casa. Assim, despeço-me.',
          footnote: []
        },
        {
          text: 'DUNCAN - Meu digno Cawdor!',
          footnote: []
        },
        {
          text: 'MACBETH <i>(à parte)</i> - Já príncipe de Cumberlândia! É escolho que ao mar me joga, se eu não abrir o\n' +
            'olho. Estrelas, escondei a luz jucunda, para que a escuridão não veja funda de meus negros anseios! Que\n' +
            'na frente da mão o olho se feche prestesmente; mas que se concretize o que, acabado, faça o olho\n' +
        ...
        {
          text: 'DUNCAN - É certo, digno Banquo; é mui valente. Dos elogios dele me alimento; são para mim\n' +
            'banquete. Acompanhemo-lo. O zelo dele vai na nossa frente para nos preparar o acolhimento. Não há\n' +
            'parente igual.',
          footnote: []
        },
        {
          text: '<i>(Fanfarras. Saem.)</i>',
          footnote: []
        },
        {
          text: '<br><center>Cena V</center>',
          footnote: []
        },
        {
          text: '<i>lnverness. Castelo de Macbeth. Entra lady Macbeth, lendo uma carta.</i>',
          footnote: []
        },
        {
          text: '"Elas me encontraram no dia da vitória e pude verificar, pela mais exata confirmação, que são dotadas de\n' +
            'saber mais do que humano. Quando eu ardia em desejos de continuar a interrogá-las, desfizeram-se em\n' +
            'ar, no qual se dissiparam. Enquanto eu me encontrava tomado de estupor com o que acontecera,\n' +
            'chegaram mensageiros do rei, que me cumprimentaram a uma voz como "Thane de Cawdor", título com\n' +
            'que, antes, me haviam saudado as irmãs feiticeiras, referindo-se ao meu futuro por este modo: "Salve!\n' +
            ...
            'queres jogo ilícito, ruas queres ganhar mal. Desejaras, grande Glamis, possuir o que te grita: "Desse\n' +
            'modo precisarás fazer, para que o tenhas!" Mas antes medo tens de fazer isso do que desejas que não\n' +
            'fique feito. Vem para cá, para que meus espíritos nos ouvidos te deite e com a ousadia de minha língua\n' +
        ...
        {
          text: '<i>(Entra um mensageiro.)</i>',
          footnote: []
        },
        {
          text: 'Quais são as novidades?',
          footnote: []
        },
        {
          text: 'MENSAGEIRO - Hoje à noite o rei chegará aqui.',
          footnote: []
        },
        {
          text: 'LADY MACBETH - Como! Estás louco? Acaso teu senhor não está com ele? Não deixaria de instruções\n' +
            'mandar-me, para os preparativos.',
          footnote: []
        },
        {
          text: 'MENSAGEIRO - Com licença. mas é verdade. Vai chegar o thane. Um dos meus camaradas a dianteira\n' +
            'dele tomou, de estafa quase morto, mal lhe restando o fôlego preciso para dar o recado.',
          footnote: []
        },
        {
          text: 'LADY MACBETH - Cuidem dele com carinho; traz grandes novidades.',
          footnote: []
        },
        {
          text: '<i>(Sai o mensageiro.)</i>',
          footnote: []
        },
        {
          text: 'Rouco está o próprio corvo que crocita a chegada fatídica de Duncan à minha fortaleza. Vinde, espíritos\n' +
            'que os pensamentos espreitais de morte, tirai-me o sexo, cheia me deixando, da cabeça até aos pés, da\n' +
            'mais terrível crueldade! Espessai-me todo o sangue; obstruí os acessos da consciência, porque batida\n' +
            'alguma compungida da natureza sacudir não venha minha hórrida vontade, promovendo acordo entre ela\n' +
            'e o ato. Ao feminino peito baixai-me, e fel bebei por leite, auxiliares do crime, de onde as vossas\n' +
            'substâncias incorpóreas sempre se acham à espreita de desgraças deste mundo. Vem, noite espessa, e\n' +
            'embuça-te no manto dos vapores do inferno mais sombrios, porque as feridas meu punhal agudo não veja\n' +
            'que fizer, nem o céu possa espreitar através do escuro manto e gritar: "Pára! Pára!"',
          footnote: []
        },
        {
          text: '<i>(Entra Macbeth)</i>',
          footnote: []
        },
        {
          text: 'Grande Glamis, digno Cawdor, maior do que ambos, ainda, pela futura saudação. Tua carta além me pôs\n' +
            'deste presente néscio, sentindo eu futuro neste instante.',
          footnote: []
        },
        {
          text: 'MACBETH - Duncan, meu caro amor, chega esta noite.',
          footnote: []
        },
        {
          text: 'LADY MACBETH - E quando vai embora?',
          footnote: []
        },
        {
          text: 'MACBETH - Amanhã mesmo, segundo pensa.',
          footnote: []
        },
        {
          text: 'LADY MACBETH - O sol, oh! nunca, nunca verá esse amanhã. Vosso rosto, meu thane, é um livro\n' +
            'aberto em que podemos ler coisas estranhas. Para o mundo enganardes, a aparência tomai do mundo;\n' +
            'tende boas-vindas nas mãos, nos olhos e na própria língua; a todos parecei flor inocente, mas sede a serpe\n' +
            'que na flor se esconde. Cuidemos do hóspede que chega, sendo que a meu cargo deveis deixar o grande\n' +
            'negócio desta noite, que nos há de legar dias e noites de alegria, de mando soberano e de valia.',
          footnote: []
        },
        {
          text: 'MACBETH - Depois conversaremos.',
          footnote: []
        },
        {
          text: 'LADY MACBETH - Só te digo que a voz mudar é revelar perigo. Deixa o resto comigo.',
          footnote: []
        },
        {
          text: '<i>(Saem.)</i>',
        ...
        {
          text: '<br><center>Cena VI</center>',
          footnote: []
        },
        {
          text: '<i>O mesmo. Diante do castelo. Oboés e tochas. Entram Duncan, Malcolm, Donalbain, Banquo, Lennox,\n' +
            'Macduff, Ross, Angus e pessoas do séquito.</i>',
          footnote: []
        },
        {
          text: 'DUNCAN - É bela a posição deste castelo. O ar afaga os sentidos delicados por maneira agradável e\n' +
            'serena. Os hóspedes do estio, as andorinhas, dos templos familiares, bem demonstram com seus ninhos\n' +
            'mimosos que o celeste hálito aqui cativa com o perfume. Não há sacada, friso, arcobotante, ou favorável\n' +
            'canto em que esses pássaros não suspendam seu leito e o berço fértil. Onde eles gostam de viver, notei-o,\n' +
            'o ar é mui delicado.',
          footnote: []
        },
        {
          text: '<i>(Entra lady Macbeth.)</i>',
          footnote: []
        },
        {
          text: 'Vede! Vede! Nossa hospedeira ilustre! O amor que segue nossos passos, por vezes nos perturba. Mas,\n' +
            'sendo amor, agradecemos sempre. Com isso vos ensino a dirigir-nos um "Deus vos recompense" pelos\n' +
            'muitos trabalhos que vos damos, e a os incômodos ainda agradecer-nos.',
          footnote: []
        },
        {
          text: 'LADY MACBETH - Fossem duplos nossos trabalhos, sob qualquer aspecto, e depois redobrados, ainda\n' +
            'foram coisinhas sem valor, se comparados com as honrarias grandes e profundas com que sobrecarrega\n' +
            'nossa casa vossa alta majestade. Pelos velhos benefícios e as honras mais recentes que lhe acrescentastes,\n' +
            'confessamo-nos como vossos devotos.',
          footnote: []
        },
        {
          text: 'DUNCAN - E onde o thane de Cawdor se meteu? No encalço dele corremos até aqui, pensando mesmo\n' +
            'que de aposentador lhe serviríamos. Mas ele monta muito bem, e o grande afeto que nos vota, agudo\n' +
            'como suas esporas, à sua própria casa o trouxe antes de nós. Formosa e digna hospedeira, esta noite\n' +
            'ficaremos aqui como vosso hóspede.',
          footnote: []
        },
        {
          text: 'LADY MACBETH - A existência tiveram sempre os servos, eles próprios e seus haveres todos como\n' +
            'simples depósito ao dispor de Vossa Alteza, pronto a ser devolvido.',
          footnote: []
        },
        {
          text: 'DUNCAN - A mão vos tomo; para o meu hospedeiro conduzi-me. Temos-lhe grande amor e\n' +
            'mostrar-lhe-emos provas ainda mais de nossa graça. Permiti-me, hospedeira.',
          footnote: []
        },
        {
          text: '<i>(Saem.)</i>',
        ...
        {
          text: '<br><center>Cena VII</center>',
          footnote: []
        },
        {
          text: '<i>O mesmo. Um quarto no castelo. Oboés e tochas. Um trinchante atravessa o palco com diversos criados,\n' +
            'que carregam pratos e acessórios da mesa. Depois entra Macbeth</i>',
          footnote: []
        },
        {
          text: 'MACBETH - Se feito fosse quanto fosse feito, seria bom fazermo-lo de pronto. Se o assassínio\n' +
            'enredasse as conseqüências e alcançasse, com o fim, êxito pleno; se este golpe aqui fosse tudo, e tudo\n' +
            'terminasse aqui em baixo, aqui somente, neste banco de areia da existência, a vida de após morte\n' +
            'arriscaríamos. Mas é aqui mesmo nosso julgamento em semelhantes casos; só fazemos ensinar as\n' +
        ...
        {
          text: 'LADY MACBETH - Já está no fim da ceia. Por que saístes?',
          footnote: []
        },
        {
          text: 'MACBETH - Perguntou por mim?',
          footnote: []
        },
        {
          text: 'LADY MACBETH - Pois ainda me fazeis essa pergunta?',
          footnote: []
        },
        {
          text: 'MACBETH - Não iremos mais longe neste assunto. Muitas honras me fez ultimamente, havendo eu\n' +
            'conquistado áureo conceito junto de toda gente, que desejo mostrar com o novo brilho, não de lado jogar\n' +
            'sem mais nem menos.',
          footnote: []
        },
        {
          text: 'LADY MACBETH - Encontra-se embriagada a esperança que até há pouco vos revestia? Adormeceu,\n' +
            'decerto, desde então e acordou agora, pálida e verde a contemplar o que ela própria começara tão bem?\n' +
            'Desde este instante para mim teu amor vale isso mesmo. Tens medo de nos atos e coragem mostrar-te\n' +
            'igual ao que és em teus anelos? Queres vir a possuir o que avalias como ornamento máximo da vida, mas\n' +
            'qual poltrão viver em tua estima, deixando que um "Não ouso" vá no rasto de um "Desejara", como o\n' +
            'pobre gato de que fala o provérbio?',
          footnote: []
        },
        {
          text: 'MACBETH - Paz, te peço. Ouso fazer tudo o que faz um homem; quem fizer mais, é que deixou de\n' +
            'sê-lo.',
          footnote: []
        },
        {
        ...
        {
          text: 'MACBETH - Se falharmos...',
          footnote: []
        },
        {
          text: 'LADY MACBETH - Falharmos? Bastará aparafusardes vossa coragem até o ponto máximo, para que\n' +
            'não falhemos. Quando Duncan se puser a dormir - e a rude viagem de hoje o convidará para isso mesmo\n' +
            '- ambos os camareiros de tal modo dominarei com vinho, que a memória, essa guarda do cérebro, fumaça\n' +
            'tão-somente será e o receptáculo da razão, alambique. E quando os corpos nesse sono de porco se\n' +
            'encontrarem, como se mortos fossem, que de coisas não faremos em Duncan indefeso, que culpas não\n' +
            'imputaremos a esses servidores-esponjas, porque fiquem responsáveis por nosso grande crime?',
          footnote: []
        },
        {
          text: 'MACBETH - Só deves dar à luz a filhos homens, pois teu vigor indômito só pode filhos homens nutrir.\n' +
            'Será aceitável, quando de sangue besuntado houvermos os dois homens que dormem no seu quarto, e\n' +
            'seus próprios punhais também usado, que foram eles os autores disso?',
          footnote: []
        },
        {
          text: 'LADY MACBETH - Quem ousará pensar de outra maneira, quando rugirmos nossa dor e os altos\n' +
            'clamores rimbombarem sobre o morto?',
          footnote: []
        },
        {
          text: 'MACBETH - Preparado me encontro e deixo tensos todos os nervos para esse ato horrível. Vamos!\n' +
  ...
  },
  {
    document: {
      ...
      paragraphs: [
        {
          text: 'Chamo-me Inácio; ele, Benedito. Não digo o resto dos nossos nomes por um\n' +
        ...
        {
          text: 'E desde logo assentemos que ele era o menos Romeu deste mundo. Tinha\n' +
        ...
        {
          text: 'Moralmente, era ele mesmo. Ninguém muda de caráter, e o do Benedito era\n' +
        ...
        {
          text: 'Conhecemo-nos em viagem para Vassouras. Tínhamos deixado o trem e entrado\n' +
        ...
        {
          text: 'Naturalmente, o primeiro objeto foi o progresso que nos traziam as estradas de\n' +
        ...
        {
          text: '— Não serão os nossos filhos que verão todo este país cortado de estradas, disse\n' +
            'ele.',
          footnote: []
        },
        {
          text: '— Não, decerto. O senhor tem filhos?',
          footnote: []
        },
        {
          text: '— Nenhum.',
        ...
        {
          text: '— Nem eu. Não será ainda em cinqüenta anos; e, entretanto, é a nossa primeira\n' +
        ...
        {
          text: '— Bonita idéia! exclamou Benedito faiscando-lhe os olhos.',
          footnote: []
        },
        {
          text: '— Importa-me pouco que seja bonita, contanto que seja justa.',
          footnote: []
        },
        {
          text: '— Bonita e justa, redargüiu ele com amabilidade. Sim, senhor, tem razão: — o\n' +
            'Brasil está engatinhando; só começará a andar quando tiver muitas estradas de\n' +
            'ferro.',
          footnote: []
        },
        {
          text: 'Chegamos a Vassouras; eu fui para a casa do juiz municipal, camarada antigo;\n' +
            ...
            'Platão. Entre o café e o <i>cognac</i>, disse-me ele, apoiando o cotovelo na borda da\n' +
            'mesa, e olhando para o charuto que ardia:',
          footnote: []
        },
        {
          text: '— Na minha viagem agora, achei ocasião de ver como o senhor tem razão com\n' +
        ...
        {
          text: '— Sim, senhor; é justamente o que o <i>senhor dizia</i> na diligência de Vassouras. Só\n' +
            'começaremos a andar quando tivermos muitas estradas de ferro. Não imagina\n' +
            'como isso é verdade.',
          footnote: []
        },
        {
          text: 'E referiu muita coisa, observações relativas aos costumes do interior,\n' +
            ...
            'os povos para os governos, mas os governos para os povos; e <i>abyssus abyssum\n' +
            'invocat</i>. Depois foi mostrar-me outras salas. Eram todas alfaiadas com apuro.\n' +
        ...
        {
          text: '— Não irei adiante, disse eu sorrindo também.',
          footnote: []
        },
        {
          text: '— Não, não há que negar, acudiu ele; foi uma moça de quem gostei muito.\n' +
        ...
        {
          text: 'Em seguida, passamos ao gabinete. Era vasto, elegante, um pouco trivial, mas\n' +
        ...
        {
          text: 'Saí encantado. Encontramo-nos algumas vezes, na rua, no teatro, em casa de\n' +
        ...
        {
          text: '— Que é isto? exclamei.',
          footnote: []
        },
        {
          text: '— Perdi a eleição, disse ele, e vim passear à Europa.',
          footnote: []
        },
        {
          text: 'Não me deixou mais; viajamos juntos o resto do tempo. Confessou-me que a\n' +
            'perda da eleição não lhe tirara a idéia de entrar no parlamento. Ao contrário,\n' +
            'incitara-o mais. Falou-me de um grande plano.',
          footnote: []
        },
        {
          text: '— Quero vê-lo ministro, disse-lhe.',
          footnote: []
        },
        {
          text: 'Benedito não contava com esta palavra, o rosto iluminou-se-lhe; mas disfarçou\n' +
            'depressa.',
          footnote: []
        },
        {
          text: '— Não digo isso, respondeu. Quando, porém, seja ministro, creia que serei tãosomente\n' +
            'ministro industrial. Estamos fartos de partidos: precisamos desenvolver\n' +
        ...
        {
          text: '— Tem razão, concordei um pouco espantado. E por que é que eu mesmo vim à\n' +
        ...
        {
          text: 'Mostrei-lhe os papéis, ele viu-os deslumbrado. Como eu tivesse então recolhido\n' +
        ...
        {
          text: 'Regressamos juntos; mas eu fiquei em Pernambuco, e tornei mais tarde a\n' +
        ...
        {
          text: '— Dentro de dois anos conto inaugurar o primeiro trecho da estrada.',
          footnote: []
        },
        {
        ...
        {
          text: '— Estão contentes, esperançados?',
          footnote: []
        },
        {
          text: '— Muito; não imagina.',
          footnote: []
        },
        {
          text: 'Contei-lhe algumas particularidades técnicas, que ele ouviu distraidamente, —\n' +
        ...
        {
          text: '— Está ainda em borrão, explicou-me; mas as idéias capitais ficam. E começou:',
          footnote: []
        },
        {
          text: '<i>No meio da agitação crescente dos espíritos, do alarido partidário\n' +
            ...
            'cortado de estradas de ferro...</i>',
          footnote: []
        },
        {
          text: 'Não pude ouvir mais nada e fiquei pensativo. Mais que pensativo, fiquei\n' +
  ...
  },
  {
    document: {
      ...
      paragraphs: [
        {
          text: 'Foi apenas ao anoitecer que Gregório acordou do seu sono profundo, que\n' +
            'mais parecera um desmaio. Ainda que nada o tivesse feito, de certo teria acordado\n' +
            'pouco mais tarde por si só, visto que se sentia suficientemente descansado e bem\n' +
            'dormido, mas parecia-lhe ter sido despertado por um andar cauteloso e pelo fechar\n' +
            'da porta que dava para o vestíbulo. Os postes da rua projetavam aqui e além um\n' +
            'reflexo pálido, no tecto e na parte superior dos móveis, mas ali em baixo, no local\n' +
            'onde se encontrava, estava escuro. Lentamente, experimentando de modo\n' +
            'desajeitado as antenas, cuja utilidade começava pela primeira vez a apreciar,\n' +
            'arrastou-se até à porta, para ver o que acontecera. Sentia todo o flanco esquerdo\n' +
            'convertido numa única cicatriz, comprida e incomodamente repuxada, e tinha\n' +
            'efetivamente de coxear sobre as duas filas de pernas. Uma delas ficara gravemente\n' +
            'atingida pelos acontecimentos dessa manhã — era quase um milagre ter sido\n' +
            'afetada apenas uma e arrastava-se, inútil, atrás de si.',
          footnote: [
            {
              index: '',
              content: ''
        ...
        {
          text: 'Só depois de chegar à porta percebeu o que o tinha atraído para ela: o cheiro\n' +
            'da comida. Com efeito, tinham lá posto uma tigela de leite dentro do qual flutuavam\n' +
            'pedacinhos de pão. Quase desatou a rir de contentamento, porque sentia ainda\n' +
            'mais fome que de manhã, e imediatamente enfiou a cabeça no leite, quase\n' +
            'mergulhando também os olhos.Depressa, a retirou, desanimado: além de ter\n' +
            'dificuldade em comer, por causa do flanco esquerdo magoado, que o obrigava a\n' +
            'ingerir a comida à força de sacudidelas, recorrendo a todo o corpo, não gostava do\n' +
            'leite, conquanto tivesse sido a sua bebida preferida e fosse certamente essa a razão\n' +
            'que levara a irmã a pôr-lhe ali, Efetivamente, foi quase com repulsa que se afastou\n' +
            'da tigela e se arrastou até meio do quarto.',
          footnote: []
        },
        {
          text: 'Através da fenda da porta, verificou que tinham acendido o gás na sala de\n' +
            'estar. Embora àquela hora o pai costumasse ler o jornal em voz alta para a mãe e\n' +
            'eventualmente também para a irmã, nada se ouvia. Bom, talvez o pai tivesse\n' +
            'recentemente perdido o hábito de ler em voz alta, hábito esse que a irmã tantas\n' +
            'vezes mencionara em conversa e por carta. Mas por todo o lado reinava o mesmo\n' +
            'silêncio, embora por certo estivesse alguém em casa. Que vida sossegada a minha\n' +
            'família tem levado! , disse Gregório, de si para si. Imóvel, a fitar a escuridão, sentiu\n' +
            'naquele momento um grande orgulho por ter sido capaz de proporcionar aos pais e\n' +
            'à irmã uma tal vida numa casa tão boa. Mas que sucederia se toda a calma, conforto\n' +
            'e satisfação acabas sem em catástrofe? Tentando não se perder em pensamentos,\n' +
            'Gregório refugiou-se no exercício físico e começou a rastejar para um lado e para o\n' +
            'outro, ao longo do quarto.',
          footnote: []
        },
        {
          text: 'A certa altura, durante o longo fim de tarde, viu as portas laterais abrir-se\n' +
            'ligeiramente e ser novamente fechada; mais tarde, sucedeu o mesmo com a porta\n' +
            'do outro lado. Alguém pretendera entrar e mudara de idéias. Gregório resolveu\n' +
            'postar-se ao pé da porta que dava para a sala de estar, decidido a persuadir\n' +
            'qualquer visitante indeciso a entrar ou, pelo menos, a descobrir quem poderia ser.\n' +
            'Mas esperou em vão, pois ninguém tornou a abrir a porta. De manhã cedo, quando\n' +
            'todas as portas estavam fechadas à chave, todos tinham querido entrar; agora, que\n' +
            'ele tinha aberto uma porta e a outra fora aparentemente aberta durante o dia,\n' +
            'ninguém entrava e até as chaves tinham sido transferidas para o lado de fora das\n' +
            'portas.',
          footnote: []
        },
        {
          text: 'Só muito tarde apagaram o gás na sala; Gregório tinha quase a certeza de\n' +
            'que os pais e a irmã tinham ficado acordados até então, pois ouvia-os afastarem-se,\n' +
            'caminhando nos bicos dos pés. Não era nada provável que alguém viesse visitá-lo até à manhã seguinte, de modo que tinha tempo de sobra para meditar sobre a\n' +
            'maneira de reorganizar a sua vida. O enorme quarto vazio dentro do qual era\n' +
            'obrigado a permanecer deitado no chão enchia-o de uma apreensão cuja causa não\n' +
            'conseguia descobrir, pois havia cinco anos que o habitava. Meio inconscientemente,\n' +
            'não sem uma leve sensação de vergonha, meteu-se debaixo do sofá, onde\n' +
            'imediatamente se sentiu bem, embora ficasse com o dorso um tanto comprimido e\n' +
            'não lhe fosse possível levantar a cabeça, lamentando apenas que o corpo fosse\n' +
            'largo de mais para caber totalmente debaixo do sofá.',
          footnote: []
        },
        {
          text: 'Ali passou toda a noite, grande parte da qual mergulhado num leve torpor, do\n' +
            'qual a fome constantemente o despertava com um sobressalto, preocupando-se\n' +
            'ocasionalmente com a sua sorte e alimentando vagas esperanças, que levavam\n' +
            'todas à mesma conclusão: devia deixar-se estar e, usando de paciência e do mais\n' +
            'profundo respeito, auxiliar a família a suportar os incômodos que estava destinado a\n' +
            'causar-lhes nas condições presentes.',
          footnote: []
        },
        {
          text: 'De manhã bem cedo, Gregório teve ocasião de pôr à prova o valor das suas\n' +
            'recentes resoluções, dado que a irmã, quase totalmente vestida, abriu a porta que\n' +
            'dava para o vestíbulo e espreitou para dentro do quarto. Não o viu imediatamente,\n' +
            'mas, ao apercebê-lo debaixo do sofá — que diabo, tinha de estar em qualquer sítio,\n' +
            'não havia de ter-se sumido, pois não? — ficou de tal modo assustada que fugiu\n' +
            'precipitadamente, batendo com a porta. Mas, teria que arrependida desse\n' +
            'comportamento, tornou a abrir a porta e entrou nos bicos dos pés, como se\n' +
            'estivesse de visita a um inválido ou a um estranho. Gregório estendeu a cabeça para\n' +
            'fora do sofá e ficou a observá-la. Notaria a irmã que ele deixara o leite intacto, não\n' +
            'por falta de fome, e traria qualquer outra comida que lhe agradasse mais ao\n' +
            'paladar? Se ela o não fizesse de moto próprio, Gregório preferiria morrer de fome a\n' +
            'chamar-lhe a atenção para o acontecimento, muito embora sentisse um irreprimível\n' +
            'desejo de saltar do seu refúgio debaixo do sofá e rojar-se-lhe aos pés, pedindo de\n' +
            'comer. A irmã notou imediatamente, com surpresa, que a tigela estava ainda cheia,\n' +
            'à exceção de uma pequena porção de leite derramado em tomo dela; ergueu logo a\n' +
            'tigela, não diretamente com as mãos, é certo, mas sim com um pano, e levou-a.\n' +
            'Gregório sentia uma enorme curiosidade de saber o que traria ela em sua\n' +
            'substituição, multiplicando conjecturas. Não poderia de modo algum adivinhar o que\n' +
            'a irmã, em toda a sua bondade, fez a seguir. Para descobrir do que gostaria ele,\n' +
            'trouxe-lhe toda uma quantidade de alimentos, sobre um pedaço velho de jornal.\n' +
            'Eram hortaliças velhas e meio podres, ossos do jantar da noite anterior, cobertos de\n' +
            'um molho branco solidificado; uvas e amêndoas, era um pedaço de queijo que\n' +
            'Gregório dois dias antes teria considerado intragável, era uma côdea de pão duro,\n' +
            'um pão com manteiga sem sal e outro com manteiga salgada. Além disso, tornou a\n' +
            'pôr no chão a mesma tigela, dentro da qual deixou água, e que pelos vistos ficaria\n' +
            'reservada para seu exclusivo uso. Depois, cheia de tacto, percebendo que Gregório\n' +
            'não comeria na sua presença, afastou-se rapidamente e deu mesmo volta chave,\n' +
            'dando-lhe a entender que podia ficar completamente à vontade. Todas as pernas de\n' +
            'Gregório se precipitaram em direção à comida. As feridas deviam estar\n' +
            'completamente curadas, além de tudo, porque não sentia qualquer incapacidade, o\n' +
            'que o espantou e o fez lembrar-se de que havia mais de um mês tinha feito um\n' +
            'golpe num dedo com uma faca e ainda dois dias antes lhe doía a ferida.',
          footnote: []
        },
        {
          text: '— Estarei agora menos sensível?, pensou, ao mesmo tempo que sugava\n' +
            'vorazmente o queijo, que, de toda a comida, era a que mais forte e imediatamente o\n' +
            'atraía. Pedaço a pedaço, com lágrimas de satisfação nos olhos, devorou rapidamente o queijo, as hortaliças e o molho; por outro lado, a comida fresca não\n' +
            'tinha atrativos para si; não podia sequer suportar-lhe o cheiro, que o obrigava até a\n' +
            'arrastar para uma certa distância os pedaços que eram capazes de comer. Tinha\n' +
            'acabado de comer havia bastante tempo e estava apenas preguiçosamente quieto\n' +
            'no mesmo local, quando a irmã rodou lentamente a chave como que a fazer-lhe sinal\n' +
            'para se retirar. Isto fê-lo levantar de súbito, embora estivesse quase adormecido, e\n' +
            'precipitar-se novamente para debaixo do sofá. Foi-lhe necessária uma considerável\n' +
            'dose de autodomínio para permanecer ali debaixo, dado que a pesada refeição lhe\n' +
            'tinha feito inchar um tanto o corpo e estava tão comprido que mal podia respirar,\n' +
            'Atacado de pequenos surtos de sufocação, sentia os olhos saírem um bocado para\n' +
            'fora da cabeça ao observar a irmã, que de nada suspeitava, varrendo não apenas os\n' +
            'restos do que comera, mas também as coisas em que não tocara, como se não\n' +
            'fossem de utilidade fosse para quem fosse, e metendo-as, apressadamente, com a\n' +
            'pá, num balde, que cobriu com uma tampa de madeira e retirou do quarto. Mal a\n' +
            'irmã virou costas, Gregório saiu de baixo do sofá, dilatando e esticando o corpo.',
          footnote: []
        },
        {
          text: 'Assim era Gregório alimentado, uma vez de manhã cedo, enquanto os pais e\n' +
            'a criada estavam ainda a dormir, e outra vez depois de terem todos almoçado, pois\n' +
            'os pais faziam uma curta sesta e a irmã podia mandar a criada fazer um ou outro\n' +
            'recado. Não que eles desejassem que ele morresse de fome, claro está, mas talvez\n' +
            'porque não pudessem suportar saber mais sobre as suas refeições do que aquilo\n' +
            'que sabiam pela boca da irmã, e talvez ainda porque a irmã os quisesse poupar a\n' +
            'todas as preocupações, por mais pequenas que fossem, visto o que eles tinham de\n' +
            'suportar ser mais do que suficiente. Uma coisa que Gregório nunca pôde descobrir\n' +
            'foi que pretexto tinha sido utilizado para se libertarem do médico e do serralheiro na\n' +
            'primeira manhã, já que, como ninguém compreendia o que ele dizia, nunca lhes\n' +
            'passara pela cabeça, nem sequer à irmã, que ele pudesse percebê-los; assim,\n' +
            'sempre que a irmã ia ao seu quarto, Gregório contentava-se em ouvi-la soltar um ou\n' +
            'outro suspiro ou exprimir uma ou outra invocação aos seus santos. Mais tarde,\n' +
            'quando se acostumou um pouco mais à situação — é claro que nunca poderia\n' +
            'acostumar-se inteiramente —, fazia por vezes uma observação que revelava uma\n' +
            'certa simpatia, ou que como tal podia ser interpretada. — Bom, hoje ele gostou do\n' +
            'jantar — disse enquanto Gregório tinha consumido boa parte da comida; quando ele\n' +
            'não comia, o que ia acontecendo com freqüência cada vez maior, dizia, quase com\n' +
            'tristeza: — Hoje tornou a deixar tudo.',
          footnote: []
        },
        {
          text: 'Embora não pudesse manter-se diretamente a par do que ia acontecendo,\n' +
            'Gregório apanhava, muitas conversas nas salas contíguas e, assim que elas se\n' +
            'tornavam audíveis, corria para a porta em questão, colando-se todo a ela. Durante\n' +
            'os primeiros dias, especialmente, não havia conversa alguma que se lhe não\n' +
            'referisse de certo modo, ainda que indiretamente. Durante dois dias houve\n' +
            'deliberações familiares sobre o que devia fazer-se; mas o assunto era igualmente\n' +
            'discutido fora das refeições visto que estavam sempre, pelo menos, dois membros\n' +
            'da família em casa: ninguém queria ficar lá sozinho e deixá-la sem ninguém estava\n' +
            'inteiramente fora da questão. Logo nos primeiros dias, a criada, cujo verdadeiro\n' +
            'conhecimento da situação não era para Gregório perfeitamente claro, caíra de\n' +
            'joelhos diante da mãe, suplicando-lhe que a deixasse ir embora. Quando saiu, um\n' +
            'quarto de hora mais tarde, agradeceu de lágrimas nos olhos o favor de ter sido\n' +
            'dispensada, como se fosse a maior graça que pudesse ser-lhe concedida e, sem\n' +
            'que ninguém lho sugerisse, prestou um solene juramento de que nunca contaria a\n' +
            'ninguém o que se passara.',
          footnote: []
        },
        {
          text: 'Agora a irmã era também obrigada a cozinhar para ajudar a mãe. É certo que\n' +
            'não era trabalho de monta, pois pouco se comia naquela casa. Gregório ouvia\n' +
            'constantemente um dos membros da família a insistir com outro para que comesse e\n' +
            'a receber invariavelmente a resposta: Não, muito obrigado, estou satisfeito, ou coisa\n' +
            'semelhante. Talvez não bebessem, sequer. Muitas vezes a irmã perguntava ao pai\n' +
            'se não queria cerveja e oferecia-se amavelmente para lha ir comprar; se ele não\n' +
            'respondia, dava a entender que podia pedir à porteira que fosse buscá-la, para que\n' +
            'ele não se sentisse em dívida, mas nessa altura o pai retorquia com um rotundo:\n' +
            'Não! e ficava o assunto arrumado.',
          footnote: []
        },
        {
          text: 'Logo no primeiro dia, o pai explicara a situação financeira e as perspectivas\n' +
            'da família a mãe e a irmã. De quando em quando, erguia-se da cadeira para ir\n' +
            'buscar qualquer recibo ou apontamento a um pequeno cofre que tinha conseguido\n' +
            'salvar do colapso financeiro em que mergulhara cinco anos atrás. Ouviam-no abrir a\n' +
            'complicada fechadura e a remexer em papéis, depois a fechá-la novamente. Tais\n' +
            'informações do pai foram às primeiras notícias agradáveis que Gregório teve desde\n' +
            'o início do cativeiro. Sempre julgara que o pai tinha perdido tudo, ou, pelo menos, o\n' +
            'pai nunca dissera nada em contrário e é evidente que Gregório nunca lho perguntara\n' +
            'diretamente. Na altura em que a ruína tinha desabado sobre o pai, o único desejo de\n' +
            'Gregório era fazer todos os possíveis para que a família se esquecesse com a maior\n' +
            ...
            'entre melhores de ganhar bem, êxito esse que depressa se converteu em metal\n' +
            'sonante que depositava na mesa, ante a surpresa e a alegria da família. Tinha sido\n' +
            'uma época feliz, que nunca viria a ser igualada, embora mais tarde Gregório\n' +
            'ganhasse o suficiente para sustentar inteiramente a casa. Tinham-se, pura e\n' +
            'simplesmente, habituado ao acontecimento, tanto a família corno ele próprio: ele\n' +
            'dava o dinheiro de boa vontade e eles aceitavam-no com gratidão, mas não havia\n' +
            'qualquer efusão de sentimentos. Só com a irmã mantivera uma certa intimidade,\n' +
            'alimentando a secreta esperança de poder mandá-la para o Conservatório no ano\n' +
            'seguinte, apesar das grandes despesas que isso acarretaria, às quais de qualquer\n' +
            'maneira haveria de fazer face, já que ela, ao contrário de Gregório, gostava imenso\n' +
            'de música e tocava violino de tal modo que comovia quantos a ouviam. Durante os\n' +
            'breves dias que passava em casa, falava muitas vezes do Conservatório nas\n' +
            'conversas com a irmã, mas sempre apenas como um belo sonho irrealizável; quanto\n' +
            'aos pais, procuravam até evitar essas inocentes referências à questão. Gregório\n' +
            'tomara a firme decisão de levar a idéia avante e tencionava anunciar solenemente o\n' +
            'acontecimento no dia de Natal.',
          footnote: []
        },
        {
          text: 'Essas eram as idéias — completamente fúteis, na sua atual situação — que\n' +
            'lhe povoavam a mente enquanto se mantinha ereto, encostado à porta, à escuta.\n' +
            'Por vezes, o cansaço obrigava-o a interrompê-la, limitando-se então a encostar a\n' +
            'cabeça à porta, mas imediatamente obrigado a endireitar-se de novo, pois até o leve\n' +
            'ruído que fazia ao mexer a cabeça era audível na sala ao lado e fazia parar todas as\n' +
            'conversas. Que estará ele a fazer agora, perguntou o pai decorridos alguns\n' +
            'instantes, virando-se decerto para a porta; só então ressuscitava gradualmente a\n' +
            'conversa antes interrompida.',
          footnote: []
        },
        {
          text: 'Dado que o pai se tomava repetitivo nas explicações — por um lado, devido\n' +
            'ao acontecimento de há muito não se encarregar de tais assuntos; por outro, graças\n' +
            'à circunstância de a mãe nem sempre perceber tudo à primeira — , Gregório ficou\n' +
            'por fim a saber que um certo número de investimentos, poucos, é certo, tinham escapado à ruína e tinham até aumentado ligeiramente, pois, entretanto, ninguém\n' +
            'tocara nos dividendos. Além disso, nem todo o dinheiro dos ordenados mensais de\n' +
            'Gregório - de que guardava para si apenas uma pequena parte — tinha sido gasto, o\n' +
            'que originara economias que constituíam um pequeno capital. Do outro lado da\n' +
            'porta, Gregório acenava ansiosamente com a cabeça, satisfeito perante aquela\n' +
            'demonstração de inesperado espírito de poupança e previsão. A verdade é que,\n' +
            'com aquele dinheiro suplementar, podia ter pago uma porção maior da dívida do pai\n' +
            'ao patrão, apressando assim o dia em que poderia deixar o emprego, mas sem\n' +
            'dúvida o pai fizera muito melhor assim.',
          footnote: []
        },
        {
          text: 'Apesar de tudo, aquele capital não era de modo nenhum suficiente para que a\n' +
            'família vivesse dos juros. Talvez o pudessem fazer durante um ano ou dois, quando\n' +
            'muito. Era, pura e simplesmente, uma quantia que urgia deixar de parte para\n' +
            'qualquer emergência. Quanto ao dinheiro para fazer face às despesas normais,\n' +
            'havia que ganhá-lo. o pai era ainda saudável, mas estava velho e não trabalhava\n' +
            'havia cinco anos, pelo que não era de esperar que fizesse grande coisa. Ao longo\n' +
            'desses cinco anos, os primeiros anos de lazer de uma vida de trabalho, ainda que\n' +
            'mal sucedido, tinha engordado e tornara-se um tanto lento. Quanto à velha mãe,\n' +
            'como poderia ganhar a vida com aquela asma, que até o simples andar agravava,\n' +
            'obrigando-a muitas vezes a deixar-se cair num sofá, a arquejar junto de uma janela\n' +
            'aberta? E seria então justo encarregar do sustento da casa a irmã, ainda uma\n' +
            'criança com os seus dezessete anos e cuja vida tinha até aí sido tão agradável e se\n' +
            'resumia a vestir-se bem, dormir bastante tempo, ajudar a cuidar da casa, ir de vez\n' +
            'em quando a diversões modestas e, sobretudo, tocar violino? A principio, sempre\n' +
            'que ouvia menções à necessidade de ganhar dinheiro, Gregório afastava-se da\n' +
            'porta e deixava-se cair no fresco sofá de couro ao lado dela, rubro de vergonha e\n' +
            'desespero.',
          footnote: []
        },
        {
          text: 'Muitas vezes ali se deixava estar durante toda a noite, sem dormir a esfregarse\n' +
            'no couro, durante horas a fio. Quando não, reunia a coragem necessária para se\n' +
            'entregar ao violento esforço de empurrar uma cadeira de braços para junto da\n' +
            'janela, trepava para o peitoril e, arrimando-se à cadeira, encostava-se às vidraças,\n' +
            'certamente obedecendo a qualquer reminiscência da sensação de liberdade que\n' +
            'sempre experimentava ao ver à janela. De fato, dia após dia, até as coisas que\n' +
            'estavam relativamente pouco afastadas se tornavam pouco nítidas; o hospital do\n' +
            'outro lado da rua, que antigamente odiava por ter sempre à frente dos olhos, ficava\n' +
            'agora bastante para além do seu alcance visual e, se não soubesse que vivia ali,\n' +
            'numa rua sossegada, de qualquer maneira, uma rua de cidade, bem poderia julgar\n' +
            'que a janela dava para um terreno deserto onde o cinzento do céu e da terra se\n' +
            'fundiam indistintamente. Esperta como era, a irmã só precisou ver duas vezes a\n' +
            'cadeira junto da janela: a partir de então, sempre que acabava de arrumar o quarto,\n' +
            'tornava a colocar a cadeira no mesmo, sítio e até deixava as portadas interiores da\n' +
            'janela abertas.',
          footnote: []
        },
        {
          text: 'Se ao menos pudesse falar com ela e agradecer-lhe tudo o que fazia por ele,\n' +
            'suportaria melhor os seus cuidados; mas naquelas condições, sentia-se oprimido. É\n' +
            'certo que ela tentava fazer, o mais despreocupadamente possível, tudo o que lhe\n' +
            'fosse desagradável, o que, com o correr do tempo, cada vez o conseguia melhor,\n' +
            'mas também Gregório, aos poucos, se ia apercebendo mais lucidamente da\n' +
            'situação. Bastava a maneira de ela entrar para o angustiar. Mal penetrava no quarto,\n' +
            'corria para a janela, sem sequer dar-se ao trabalho de fechar a porta atrás de si,\n' +
            'apesar do cuidado que costumam ter em ocultar aos outros a visão de Gregório, e,\n' +
            'como se estivesse pontos de sufocar, abria precipitadamente a janela e ali ficava a apanhar ar durante um minuto, por mais frio que fizesse, respirando profundamente.\n' +
            'Duas vezes por dia, incomodava Gregório com a sua ruidosa precipitação, que o\n' +
            'fazia refugiar-se, a tremer, debaixo do sofá, durante todo o tempo, ciente de que a\n' +
            'irmã certamente o pouparia a tal incômodo se lhe fosse possível permanecer na sua\n' +
            'presença sem abrir a janela.',
          footnote: []
        },
        {
          text: 'Certa vez, coisa de um mês após a metamorfose de Gregório, quando já não\n' +
            'havia por certo motivo para assustar-se com o seu aspecto, apareceu ligeiramente\n' +
            'mais cedo do que era habitual e deu com ele a ver à janela, imóvel, numa posição\n' +
            'em que parecia um espectro. Gregório não se surpreenderia se ela não entrasse\n' +
            'pura e simplesmente, pois não podia abrir imediatamente a janela enquanto ele ali\n' +
            'estivesse, mas ela não só evitou entrar como deu um salto para trás, diria que\n' +
            'alarmada, e bateu com a porta em retirada. Um estranho que observasse a cena\n' +
            'julgaria com certeza que Gregório a esperava para lhe morder. É claro que\n' +
            'imediatamente se escondeu debaixo do sofá, mas ela só voltou ao meio-dia com um\n' +
            'ar bastante mais perturbado do que era vulgar. Este acontecimento revelou a\n' +
            'Gregório a repulsa que o seu aspecto provocava ainda à irmã e o esforço que devia\n' +
            'custar-lhe não desatar a correr mal via a pequena porção do seu corpo que aparecia\n' +
            'sob o sofá. Nestas condições, decidiu um dia poupá-la a tal visão e, à custa de\n' +
            'quatro horas de trabalho, pôs um lençol pelas costas e dirigiu-se para o sofá,\n' +
            'dispondo-o de modo a ocultar-lhe totalmente o corpo, mesmo que a irmã se\n' +
            'baixasse para espreitar. Se ela achasse desnecessário o lençol, decerto o tiraria do\n' +
            'sofá, visto ser evidente que aquela forma de ocultação e confinamento em nada\n' +
            'contribuíam para o conforto de Gregório; neste instante, ela deixou o lençol onde\n' +
            'estava e ele teve mesmo a impressão de surpreender-lhe um olhar de gratidão, ao\n' +
            'levantar cuidadosamente uma ponta do lençol para ver qual a reação da irmã àquela\n' +
            'nova disposição.',
          footnote: []
        },
        {
          text: 'Durante os primeiros quinze dias, os pais não conseguiram reunir a coragem\n' +
            'necessária para entrarem no quarto de Gregório, que freqüentemente os ouvia\n' +
            'elogiarem a atividade da irmã, que anteriormente costumavam repreender, por a\n' +
            'considerarem, até certo ponto, uma lia inútil. Agora, era freqüente esperarem ambos\n' +
            'à porta, enquanto a irmã procedia à limpeza do quarto, perguntando-lhe logo que\n' +
            'saía como corriam as coisas lá dentro, o que tinha Gregório comido, como se\n' +
            'comportara desta vez e se porventura não melhorara um pouco. A mãe, essa,\n' +
            'começou relativamente cedo a pretender visitá-lo, mas o pai e a irmã tentaram logo\n' +
            'dissuadi-la, contrapondo argumentos que Gregório escutava atentamente, e que ela\n' +
            'aceitou totalmente. Mais tarde, só conseguiam removê-la pela forca e, quando ela\n' +
            'exclamava, a chorar: Deixem-me ir ver o Gregório, o meu pobre filho! Não percebem\n' +
            'que tenho de ir vê-lo, Gregório pensava que talvez fosse bom que ela lá fosse, não\n' +
            'todos os dias, claro, mas talvez uma vez por semana; no fim de contas, ela havia de\n' +
            'compreender, muito melhor que a irmã, que não passava de uma criança, apesar\n' +
            'dos esforços que fazia e aos quais talvez se tivesse entregado por mera consciência\n' +
            'infantil.',
          footnote: []
        },
        {
          text: 'O desejo que Gregório sentia de ver a mãe não tardou em ser satisfeito.\n' +
            'Durante o dia evitava mostrar-se à janela, por consideração para com os pais, mas\n' +
            'os poucos metros quadrados de chão de que dispunha não davam para grandes\n' +
            'passeios, nem lhe seria possível passar toda a noite imóvel; por outro lado, perdia\n' +
            'rapidamente todo e qualquer gosto pela comida.Para se distrair, adquirira o hábito\n' +
            'de se arrastar ao longo das paredes e do tecto.Gostava particularmente de manterse\n' +
            'suspenso do tecto, coisa muito melhor do que estar no chão: a respiração\n' +
            'tornava-se-lhe mais livre, o corpo oscilava e coleava suavemente e, quase beatificamente absorvido por tal suspensão, chegava a deixar-se cair ao chão.\n' +
            'Possuindo melhor coordenação dos movimentos do corpo, nem uma queda daquela\n' +
            'altura tinha conseqüências. A irmã notara imediatamente esta nova distração de\n' +
            'Gregório, visto que ele deixava atrás de si, ao deslocar-se, marcas da substância\n' +
            'pegajosa das extremidades das pernas, e meteu-se-lhe na cabeça arranjar-lhe a\n' +
            'maior porção de espaço livre possível para os passeios, retirando as peças de\n' +
            'mobiliário que constituíssem obstáculos para o irmão, especialmente a cômoda e a\n' +
            'secretária.A tarefa era demasiado pesada para si e, se não se atrevia a pedir ajuda\n' +
            'ao pai, estava fora de questão recorrer à criada, uma menina de dezesseis anos que\n' +
            'havia tido a coragem de ficar após a partida da cozinheira, visto que a moça tinha\n' +
            'pedido o especial favor de manter a porta da cozinha fechada à chave e abri-la\n' +
            'apenas quando expressamente a chamavam. Deste modo, só lhe restava apelar\n' +
            'para a mãe numa altura em que o pai não estivesse em casa. A mãe anuiu-se, entre\n' +
            'exclamações de ávida satisfação, que diminuíram junto à porta do quarto de\n' +
            'Gregório. É claro que a irmã entrou primeiro, para verificar se estava tudo em ordem\n' +
            'antes de deixar a mãe entrar. Gregório puxou precipitadamente o lençol para baixo e\n' +
            'dobrou-o mais, de maneira a parecer que tinha sido acidentalmente atirado para\n' +
            'cima do sofá. Desta vez não deitou a cabeça de fora para espreitar, renunciando ao\n' +
            'prazer de ver a mãe pela satisfação de ela ter decidido afinal visitá-lo.',
          footnote: []
        },
        {
          text: '— Entre, que ele não está à vista - disse a irmã, certamente guiando-a pela\n' +
            'mão.',
          footnote: []
        },
        {
          text: 'Gregório ouvia agora as duas mulheres a esforçarem-se por deslocar a\n' +
            'pesada cômoda e a irmã a chamar a si a maior parte do trabalho, sem dar ouvidos\n' +
            'às admoestações da mãe, receosa de que a filha estivesse a fazer esforços\n' +
            'demasiados. A manobra foi demorada. Passado, pelo menos, um quarto de hora de\n' +
            'tentativas, a mãe objetou que o melhor seria deixar a cômoda onde estava, em\n' +
            'primeiro lugar, porque era pesada de mais e nunca conseguiriam deslocá-la antes\n' +
            'da chegada do pai e, se ficasse no meio do quarto, como estava, só dificultaria os\n' +
            'movimentos de Gregório; em segundo lugar, nem sequer havia a certeza de que a\n' +
            'remoção da mobília lhe prestasse um serviço. Tinha a impressão do contrário; a\n' +
            'visão das paredes nuas deprimia-a, e era natural que sucedesse o mesmo a\n' +
            'Gregório, dado que estava habituado à mobília havia muito tempo e a sua ausência\n' +
            'poderia fazê-lo sentir-se só.',
          footnote: []
        },
        {
          text: '— Não é verdade — disse em voz baixa, aliás pouco mais que murmurara,\n' +
            'durante todo o tempo, como se quisesse evitar que Gregório, cuja localização exata\n' +
            'desconhecia, lhe reconhecesse sequer o tom de voz, pois estava convencida de que\n' +
            'ele não percebia as palavras —, não é verdade que, retirando-lhe a mobília, lhe\n' +
            'mostramos não ter já qualquer esperança de que ele se cure e que o abandonamos\n' +
            'impiedosamente à sua sorte? Acho que o melhor é deixar o quarto exatamente como\n' +
            'sempre esteve, para que ele, quando voltar para nós, encontre tudo na mesma e\n' +
            'esqueça com mais facilidade o que aconteceu entretanto.',
          footnote: []
        },
        {
          text: 'Ao ouvir as palavras da mãe, Gregório apercebeu-se de que a falta de\n' +
            'conversação direta com qualquer ser humano, durante os dois últimos meses, aliada\n' +
            'à monotonia da vida em família, lhe deviam ter perturbado o espírito; se assim não\n' +
            'fosse, não teria genuinamente ansiado pela retirada da mobília do quarto. Quereria,\n' +
            'efetivamente, que o quarto acolhedor, tão confortavelmente equipado com a velha mobília da família, se transformasse numa caverna nua onde decerto poderia\n' +
            'arrastar-se livremente em todas as direções, à custa do simultâneo abandono de\n' +
            'qualquer reminiscência do seu passado humano? Sentia-se tão perto desse\n' +
            'esquecimento total que só a voz da mãe, que há tanto tempo não ouvia, não lhe\n' +
            'permitira mergulhar completamente nele. Nada devia ser retirado do quarto. Era\n' +
            'preciso que ficasse tudo como estava, pois não podia renunciar à influência positiva\n' +
            'da mobília, no estado de espírito em que se encontrava, e, mesmo que o mobiliário\n' +
            'lhe perturbasse as voltas sem sentido, isso não redundava em prejuízo, mas sim em\n' +
            'vantagem.',
          footnote: []
        },
        {
          text: 'Infelizmente a irmã era de opinião contrária; habituara-se, e não sem motivos,\n' +
            'a considerar-se uma autoridade no que respeitava a Gregório, em contradição com\n' +
            'os pais, de modo que a presente opinião da mãe era suficiente para a decidir a\n' +
            'retirar, não só a cômoda e a secretária, mas toda a mobília, à exceção do\n' +
            'indispensável sofá. É certo que esta decisão não era conseqüência da simples\n' +
            'teimosia infantil nem da autoconfiança que recentemente adquirira, tão inesperada\n' +
            'como penosamente; tinha, efetivamente, percebido que Gregório precisava de uma\n' +
            'porção de espaço para vaguear e, tanto quanto lhe era dado observar, Gregório\n' +
            'nunca usara sequer a mobília. Outro fator terá porventura sido igualmente o\n' +
            'temperamento entusiástico de qualquer menina adolescente, que tende a\n' +
            'manifestar-se em todas as ocasiões possíveis e que agora levava Grete a exagerar\n' +
            'o drama da situação do irmão, a fim de poder auxiliá-lo mais ainda. Num quarto onde\n' +
            'Gregório reinasse rodeado de paredes nuas, havia fortes probabilidades de ninguém\n' +
            'alguma vez entrar, a não ser ela.',
          footnote: []
        },
        {
          text: 'Assim, não se deixou dissuadir pela mãe, que parecia cada vez menos à\n' +
            'vontade no quarto, estado de espírito que só contribuía para sentir-se mais insegura.\n' +
            'Rapidamente reduzida ao silêncio, limitou-se, pois, a ajudar a filha a retirar a\n' +
            'cômoda, na medida do possível. Ora, sem a cômoda podia Gregório muito bem\n' +
            'passar, mas era forçoso que conservasse a secretária. Logo que as mulheres\n' +
            'removeram a cômoda, à força de arquejantes arrancos, Gregório pôs a cabeça de\n' +
            'fora, para ver como poderia intervir da maneira mais delicada e cuidadosa. Quis o\n' +
            'destino que fosse a mãe a primeira a regressar, enquanto Grete, no quarto contíguo,\n' +
            'tentava deslocar sozinha a cômoda, evidentemente debalde. Como a mãe não\n' +
            'estava habituada ao seu aspecto, era provável que sofresse um grande choque ao\n' +
            'vê-lo. Receando que tal acontecesse, Gregório recuou precipitadamente para a\n' +
            'outra extremidade do sofá, mas não conseguiu evitar que o lençol se agitasse\n' +
            'ligeiramente. Esse movimento foi o bastante para alertar a mãe, que ficou imóvel por\n' +
            'um instante e em seguida se refugiou junto de Grete.',
          footnote: []
        },
        {
          text: 'Embora Gregório tentasse convencer-se de que nada de anormal se passava,\n' +
            'que se tratava apenas de uma mudança de algumas peças de mobiliário, acabou\n' +
            'por reconhecer que as idas e vindas das mulheres, os sons momentâneos que\n' +
            'produziam e o arrastar de móveis o afetavam como se tratasse de uma indisposição\n' +
            'que viesse de todos os lados ao mesmo tempo e, por mais que encolhesse a cabeça\n' +
            'e as pernas e se acachapasse no chão, viu-se perante a certeza de que não poderia\n' +
            'continuar a suportar tudo aquilo por muito tempo. Tiravam-lhe tudo do quarto,\n' +
            'privavam-no de tudo o que lhe agradava: a cômoda onde guardava a serra de\n' +
            'recorte e as outras ferramentas tinha sido retirada, e agora tentavam remover a\n' +
            'secretária, que quase parecia colada ao chão, na qual fizera todos os trabalhos de\n' +
            'casa quando freqüentara a escola comercial, e, antes disso, o liceu e, pois era, até a\n' +
            'escola primária... Não conseguia deter-se a analisar as boas intenções das duas\n' +
            'mulheres, cuja existência quase tinha esquecido nessa altura, visto estarem tão exaustas que se dedicavam ao trabalho em silêncio, ouvindo-se apenas o pesado\n' +
            'arrastar dos pés de ambas.',
          footnote: []
        },
        {
          text: 'Nestas condições, apressou-se a sair do esconderijo, ao mesmo tempo que\n' +
            'as mulheres, no quarto ao lado, se apoiavam na secretária, tomando fôlego. Quatro\n' +
            'vezes mudou de direção, pois não sabia o que salvar primeiro. De repente, avistou\n' +
            'na parede oposta, totalmente liberta de mobiliário, a figura da mulher envolta em\n' +
            'peles; trepou rapidamente pela parede e colou-se ao vidro da moldura, que\n' +
            'constituía uma superfície à qual o seu corpo aderia bem e que lhe refrescava\n' +
            'agradavelmente o ventre escaldante. Pelo menos o quadro, que o corpo de Gregório\n' +
            'ocultava totalmente, ninguém havia de retirar. Voltou a cabeça para a porta da sala\n' +
            'de estar, a fim de poder observar as mulheres quando regressassem.',
          footnote: []
        },
        {
          text: 'Pouco tinham descansado, visto que regressavam nesse momento, a mãe\n' +
            'quase apoiada a Grete, que lhe passara o braço em torno da cintura.',
          footnote: []
        },
        {
          text: '— Bem, que havemos de tirar agora? perguntou Grete, olhando em volta.',
          footnote: []
        },
        {
          text: 'Foi então que deparou com Gregório. Manteve a compostura, provavelmente\n' +
            'em atenção à mãe, e inclinou a cabeça para ela, a fim de evitar que levantasse a\n' +
            'vista. Ao mesmo tempo, perguntou-lhe, em voz trêmula e desabrida:',
          footnote: []
        },
        {
          text: '— Não será melhor voltarmos um instante ao refeitório?',
          footnote: []
        },
        {
          text: 'Gregório adivinhou facilmente as intenções de Grete: queria pôr a mãe a\n' +
            'salvo e enxotá-lo seguidamente da parede. Muito bem, ela que experimentasse!\n' +
            'Agarraria ao quadro e não cederia. Preferia avançar sobre o rosto de Grete.',
          footnote: []
        },
        {
          text: 'Mas as palavras de Grete não haviam logrado senão desassossegar a mãe,\n' +
            'que deu um passo para o lado e encarou o enorme vulto castanho no florido papel\n' +
            'da parede. Antes de tomar perfeita consciência de que se tratava de Gregório, gritou\n' +
            'roucamente:',
          footnote: []
        },
        {
          text: '— Ai, meu Deus! Ai, meu Deus!- e deixou-se desmaiar de braços abertos no\n' +
            'sofá, não dando mais sinal de vida.',
          footnote: []
        },
        {
          text: '— Gregório! - gritou a irmã, fitando-o com um punho cerrado erguido na sua\n' +
            'direção. Era a primeira vez que se lhe dirigia diretamente depois da metamorfose.\n' +
            'Correu à sala contígua em busca de um frasco de sais para reanimar a mãe.\n' +
            'Gregório quis igualmente ajudar, pois havia tempo para salvar o quadro, mas teve de\n' +
            'fazer grande esforço para se descolar do vidro. Ao consegui-lo, correu atrás da irmã\n' +
            'para a sala contígua, como se pudesse aconselhá-la, a exemplo do que costumava\n' +
            'fazer, mas não teve outro remédio senão deixar-se ficar desamparadamente atrás\n' +
            'dela. Grete remexia por entre vários frascos e, ao virar-se, entrou em pânico ante a\n' +
            'visão de Gregório. Um dos frascos caiu ao chão, partindo-se. Ao saltar, um caco\n' +
            'cortou o focinho de Gregório, ao mesmo tempo que uma droga corrosiva lhe\n' +
            'salpicava o corpo. Sem mais detenças, Grete agarrou em todos os frascos que lhe\n' +
            'era possível transportar e correu para a mãe, fechando violentamente a porta com o\n' +
            'pé. Gregório via-se assim separado da mãe, que talvez estivesse à beira da morte,\n' +
            'por sua culpa. Não se atrevia a abrir a porta, receando assustar Grete, que tinha de\n' +
            'cuidar da mãe. Só lhe restava esperar. Consumido pelo remorso e cuidado,\n' +
            'começou a andar para um lado e para o outro, trepando tudo, paredes, mobília e\n' +
            'tecto. Finalmente, acossado pelo desespero, viu a sala a andar à roda e caiu no\n' +
            'meio da grande mesa.',
          footnote: []
        },
        {
          text: 'Decorridos alguns instantes, Gregório estava ainda impotentemente deitado\n' +
            'na mesa, cercado pelo silêncio, que constituía talvez um bom sintoma. Depois soou\n' +
            'a campainha da porta. A criada estava certamente fechada na cozinha e tinha que\n' +
            'ser Grete a abrir a porta. Era o pai.',
          footnote: []
        },
        {
          text: '— Que aconteceu? — foram as suas primeiras palavras. A expressão de\n' +
            'Grete deve ter sido suficientemente elucidativa. Respondeu em voz abafada,\n' +
            'aparentemente com a cabeça oculta no peito:',
          footnote: []
        },
        {
          text: '— A mãe teve um desmaio, mas está melhor. Foi o Gregório que se soltou.',
          footnote: []
        },
        {
          text: '— Bem me parecia — replicou o pai. — Eu bem vos avisei, mas vocês, as\n' +
            'mulheres, nunca ligam.',
          footnote: []
        },
        {
          text: 'Era evidente para Gregório que o pai tinha interpretado da pior maneira\n' +
            'possível a explicação demasiado curta de Grete e imaginava Gregório culpado de\n' +
            'qualquer ato violento. Urgia, portanto, deixar o pai acalmar-se, visto que não tinha\n' +
            'tempo nem processo de dar explicações. Precipitou-se assim para a porta do quarto\n' +
            'e comprimiu-se contra ela, para que o pai visse, ao passar do vestíbulo, que o filho\n' +
            'tinha tido a louvável intenção de regressar imediatamente ao quarto e que, por\n' +
            'conseguinte, não era preciso obrigá-lo a recolher-se ali, pois desapareceria num\n' +
            'ápice, se simplesmente a porta estivesse aberta.',
          footnote: []
        },
        {
          text: 'O pai não estava em estado de espírito que lhe permitisse essas\n' +
            'substituições. Mal o avistou, gritou um Ali simultaneamente irado e exultante.\n' +
            'Gregório afastou a cabeça da porta e virou-a para o pai. Para dizer a verdade, não\n' +
            'era o pai que imaginara; tinha de admitir que ultimamente se deixara absorver de tal\n' +
            'modo pela diversão de caminhar pelo tecto que não dava a atenção de outros\n' +
            'tempos ao que se passava no resto da casa, embora fosse obrigação sua estar\n' +
            'preparado para certas alterações. Mas, ao mesmo tempo, seria aquele realmente o\n' +
            'seu pai? Seria o mesmo homem que costumava ver pesadamente deitado na cama\n' +
            'quando partia para cada viagem? Que o cumprimentava quando ele voltava, à noite,\n' +
            'deitado, de pijama, numa cadeira de braços? Que não conseguia ter-se de pé e se\n' +
            'limitava a erguer os braços para o saudar? Que, nas raras vezes em que saía com o\n' +
            'resto da família, um ou dois domingos por ano, nas férias, caminhava entre Gregório\n' +
            'e a mãe; andavam bem devagar, o pai ainda mais vagarosamente do que eles,\n' +
            'atabafado dentro do velho sobretudo, arrastando-se laboriosamente com o auxílio da\n' +
            'bengala, que pousava cautelosamente em cada degrau e que, sempre que tinha\n' +
            'alguma coisa para dizer, quase sempre era obrigado a parar e a juntá-los todos à\n' +
            'sua volta?',
          footnote: []
        },
        {
          text: 'Agora estava ali de pé firme, envergando urna bela farda azul de botões\n' +
            'dourados, das que os contínuos dos bancos usam; o vigoroso duplo queixo\n' +
            'espetava-se para fora da dura gola alta do casaco e, sob as espessas sobrancelhas,\n' +
            'brilhavam-lhe os olhos pretos, vívidos e penetrantes. Os cabelos brancos outrora\n' +
            'emaranhados dividiam-se agora, bem lisos, para um e outro lado de uma risca ao\n' +
            'meio, impecavelmente traçada. Lançou vigorosamente o boné, que tinha bordado o\n' +
            'monograma de qualquer banco, para cima de um sofá, no outro extremo da sala e,\n' +
            'corri as largas abas do casaco, avançou ameaçadoramente para Gregório.\n' +
            'Provavelmente, nem ele próprio sabia o que ia fazer, mas, fosse corno fosse, ergueu\n' +
            'o pé a uma altura pouco natural, aterrando Gregório ante o tamanho descomunal\n' +
            'das solas dos sapatos. Mas Gregório não podia arriscar-se a enfrentá-lo, pois desde\n' +
            'o primeiro dia da sua nova vida se tinha apercebido de que o pai considerava que só\n' +
            'se podia lidar com ele adotando as mais violentas medidas. Nestas condições, desatou a fugir do pai, parando quando ele parava e precipitando-se novamente em frente ao menor movimento do pai.',
          footnote: []
        },
        {
          text: 'Foi assim que deram várias voltas ao quarto, sem que nada de definido\n' +
            'sucedesse; aliás, tudo aquilo estava longe de assemelhar-se sequer a uma\n' +
            'perseguição, dada a lentidão com que se processava. Gregório resolveu manter-se\n' +
            'no chão, não fosse o pai interpretar como manifestação declarada de perversidade\n' +
            'qualquer excursão pelas paredes ou pelo tecto. Apesar disso, não podia suportar\n' +
            'aquela corrida por muito mais tempo, uma vez que, por cada passada do pai, era\n' +
            'obrigado a empenhar-se em toda uma série de movimentos e, da mesma maneira\n' +
            'que na vida anterior nunca tivera uns pulmões famosos, começava a perder o fôlego.\n' +
            'Prosseguia ofegante, tentando concentrar todas as energias na fuga, mal mantendo\n' +
            'os olhos abertos, tão apatetado que não conseguia sequer imaginar qualquer\n' +
            'processo de escapar a não ser continuar em frente, quase esquecendo que podia\n' +
            'utilizar as paredes, repletas de mobílias ricamente talhadas, cheias de saliências e\n' +
            'reentrâncias. De súbito, sentiu embater perto de si e rolar à sua frente qualquer\n' +
            'coisa que fora violentamente arremessada. Era uma maçã, à qual logo outra se\n' +
            'seguiu.Gregório deteve-se, assaltado pelo pânico. De nada servia continuar a fugir,\n' +
            'uma vez que o pai resolvera bombardeá-lo. Tinha enchido os bolsos de maçãs, que\n' +
            'tirara da fruteira do aparador, e atirava-lhas uma a uma, sem grandes preocupações\n' +
            'de pontaria. As pequenas maçãs vermelhas rebolavam no chão como que\n' +
            'magnetizadas e engatilhadas umas nas outras. Uma delas, arremessada sem\n' +
            'grande força, roçou o dorso de Gregório e ressaltou sem causar-lhe dano. A que se\n' +
            'seguiu, penetrou-lhe nas costas.Gregório tentou arrastar-se para a frente, como se,\n' +
            'fazendo-o, pudesse deixar para trás a incrível dor que repentinamente sentiu, mas\n' +
            'sentia-se pregado ao chão e só conseguiu acaçapar-se, completamente\n' +
            'desorientado. Num último olhar, antes de perder a consciência, viu a porta abrir-se\n' +
            'de repente e a mãe entrar de roldão à frente da filha, em trajos mais pequenas, pois\n' +
            'Grete tinha-a libertado da roupa para lhe permitir melhor respiração e reanimá-la. Viu\n' +
            'ainda a mãe correr para o pai, deixando cair no chão as saias de baixo, uma após\n' +
            'outra, tropeçar nelas e cair nos braços do pai, em completa união com ele nesse\n' +
            'instante, a vista de Gregório começou a falhar, enclavinhando-lhe as mãos em redor\n' +
            'do pescoço e pedindo-lhe que poupasse a vida ao filho.',
          footnote: []
        }
      ]
    }
